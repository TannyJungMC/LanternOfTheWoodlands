...
import lantern_of_the_woodlands.procedures.BasicSpell2lightHitBlockProcedure;
...
public class LightBlock extends LanternOfTheWoodlandsModElements.ModElement {
	@ObjectHolder("lantern_of_the_woodlands:light")
	public static final Block block = null;

	public LightBlock(LanternOfTheWoodlandsModElements instance) {
		super(instance, 317);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.SNOW).hardnessAndResistance(1f, 10f).setLightLevel(s -> 15)
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("> right click to summon a light"));
			list.add(new StringTextComponent("> hold shift and place to summon with +3 high"));
