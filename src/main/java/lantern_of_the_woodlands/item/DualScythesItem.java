...
public class DualScythesItem extends LanternOfTheWoodlandsModElements.ModElement {
	@ObjectHolder("lantern_of_the_woodlands:dual_scythes")
	public static final Item block = null;

	public DualScythesItem(LanternOfTheWoodlandsModElements instance) {
		super(instance, 440);
	}
	...
	public void initElements() {
		elements.items.add(() -> new SwordItem(new IItemTier() {
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("> deal damage in area"));
				list.add(new StringTextComponent("--------------------"));
			}
		}.setRegistryName("dual_scythes"));
	}
}
