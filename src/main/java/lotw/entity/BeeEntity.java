...
import lotw.procedures.BasicSpell7whenDieProcedure;

import lotw.itemgroup.LotwTabItemGroup;

import lotw.entity.renderer.BeeRenderer;
...
public class BeeEntity extends LotwModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.4f, 0.7f)).build("bee").setRegistryName("bee");

	public BeeEntity(LotwModElements instance) {
		super(instance, 1043);
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(LotwTabItemGroup.tab)).setRegistryName("bee_spawn_egg"));
	}
	...
	private static class EntityAttributesRegisterHandler {
		...
		public void onEntityAttributeCreation(EntityAttributeCreationEvent event) {
			...
			ammma = ammma.createMutableAttribute(Attributes.FOLLOW_RANGE, 30);
	...
	public static class CustomEntity extends CreatureEntity {
		...
		public void onDeath(DamageSource source) {
			...
			BasicSpell7whenDieProcedure.executeProcedure(Stream
