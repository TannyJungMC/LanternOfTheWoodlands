...
import lotw.procedures.Spell2trackerHitBlockProcedure;

import lotw.itemgroup.LotwTabItemGroup;

import lotw.entity.renderer.TrackerRenderer;
...
public class TrackerItem extends LotwModElements.ModElement {
	@ObjectHolder("lotw:tracker")
	...
	public TrackerItem(LotwModElements instance) {
		super(instance, 159);
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(LotwTabItemGroup.tab).maxDamage(3));
