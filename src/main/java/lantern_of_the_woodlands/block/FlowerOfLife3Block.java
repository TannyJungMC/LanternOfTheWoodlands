...
public class FlowerOfLife3Block extends LanternOfTheWoodlandsModElements.ModElement {
	@ObjectHolder("lantern_of_the_woodlands:flower_of_life_3")
	public static final Block block = null;

	public FlowerOfLife3Block(LanternOfTheWoodlandsModElements instance) {
		super(instance, 505);
	}
