...
public class BasicSpell6openGUIGuiWindow extends ContainerScreen<BasicSpell6openGUIGui.GuiContainerMod> {
	...
	private static final ResourceLocation texture = new ResourceLocation("lantern_of_the_woodlands:textures/screens/basic_spell_6open_gui.png");
	...
	protected void drawGuiContainerForegroundLayer(MatrixStack ms, int mouseX, int mouseY) {
		this.font.drawString(ms, "Invitation", -27, -85, -10092544);
		this.font.drawString(ms, "nature mage's", -40, -67, -10079488);
		this.font.drawString(ms, "invite you to", -36, -58, -10079488);
		this.font.drawString(ms, "Time Left : " + (LanternOfTheWoodlandsModVariables.MapVariables.get(world).basicspell6_time_left) + "", -36, 5,
				-6724096);
	...
	public void init(Minecraft minecraft, int width, int height) {
		...
		this.addButton(new Button(this.guiLeft + -27, this.guiTop + 23, 54, 20, new StringTextComponent("Accept"), e -> {
			if (true) {
				LanternOfTheWoodlandsMod.PACKET_HANDLER.sendToServer(new BasicSpell6openGUIGui.ButtonPressedMessage(0, x, y, z));
		...
		this.addButton(new Button(this.guiLeft + -27, this.guiTop + 46, 54, 20, new StringTextComponent("Refuse"), e -> {
			if (true) {
				LanternOfTheWoodlandsMod.PACKET_HANDLER.sendToServer(new BasicSpell6openGUIGui.ButtonPressedMessage(1, x, y, z));
