				...
				if (true) {
					{
						...
						if (!_ent.level().isClientSide() && _ent.getServer() != null) {
							_ent.getServer().getCommands().performPrefixedCommand(
									...
									ReplaceIDProcedure.execute(entity, ("execute positioned ^ ^ ^" + 2 + " run ") + "" + SummonArmorStandProcedure.execute(
											"ArmorItems:[{},{},{},{id:\"" + "" + item_id + "\",Count:1b}],Pose:{Head:[" + entity.getXRot() + "f,0f,0f]},Rotation:[" + entity.getYRot() + "f," + entity.getXRot() + "f]", "spell4 / spell4_" + name)));
						}
					}
					{
						Entity _ent = entity;
