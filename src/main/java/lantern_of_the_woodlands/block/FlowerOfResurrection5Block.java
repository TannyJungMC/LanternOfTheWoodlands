...
public class FlowerOfResurrection5Block extends LanternOfTheWoodlandsModElements.ModElement {
	@ObjectHolder("lantern_of_the_woodlands:flower_of_resurrection_5")
	public static final Block block = null;

	public FlowerOfResurrection5Block(LanternOfTheWoodlandsModElements instance) {
		super(instance, 527);
	}
