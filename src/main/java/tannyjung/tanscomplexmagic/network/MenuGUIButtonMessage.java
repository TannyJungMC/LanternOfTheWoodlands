...
public record MenuGUIButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	...
	public static final Type<MenuGUIButtonMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(TanscomplexmagicMod.MODID, "menu_gui_buttons"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		TanscomplexmagicMod.addNetworkMessage(MenuGUIButtonMessage.TYPE, MenuGUIButtonMessage.STREAM_CODEC, MenuGUIButtonMessage::handleData);
	}
}