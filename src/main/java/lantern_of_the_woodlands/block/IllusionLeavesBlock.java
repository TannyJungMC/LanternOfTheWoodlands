...
public class IllusionLeavesBlock extends LanternOfTheWoodlandsModElements.ModElement {
	@ObjectHolder("lantern_of_the_woodlands:illusion_leaves")
	public static final Block block = null;

	public IllusionLeavesBlock(LanternOfTheWoodlandsModElements instance) {
		super(instance, 562);
