...
public class FlowerOfLife5Block extends LanternOfTheWoodlandsModElements.ModElement {
	@ObjectHolder("lantern_of_the_woodlands:flower_of_life_5")
	public static final Block block = null;

	public FlowerOfLife5Block(LanternOfTheWoodlandsModElements instance) {
		super(instance, 507);
	}
