...
import tannyjung.lanternofthewoodlands.procedures.Spell4GUIreturnLanternStatusProcedure;
import tannyjung.lanternofthewoodlands.procedures.Spell4GUIreturnLanternLevelProcedure;
import tannyjung.lanternofthewoodlands.procedures.Spell4GUIreturnLanternCountProcedure;
...
import tannyjung.lanternofthewoodlands.network.Spell4GUIweaponLanternButtonMessage;
...
public class Spell4GUIweaponLanternScreen extends AbstractContainerScreen<Spell4GUIweaponLanternMenu> implements WidgetScreen {
	private final static HashMap<String, Object> guistate = Spell4GUIweaponLanternMenu.guistate;
	...
	ImageButton imagebutton_icon_spell_lantern_manipulation;
	ImageButton imagebutton_icon_spell_lantern_light;
	...
	private static final ResourceLocation texture = new ResourceLocation("lanternofthewoodlands:textures/screens/spell_4_gu_iweapon_lantern.png");
	...
	public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		if (mouseX > leftPos + -132 && mouseX < leftPos + -124 && mouseY > topPos + 52 && mouseY < topPos + 60)
			guiGraphics.renderTooltip(font, Component.translatable("gui.lanternofthewoodlands.spell_4_gu_iweapon_lantern.tooltip_activate_weapons_on_ground_near1"), mouseX, mouseY);
		if (mouseX > leftPos + -120 && mouseX < leftPos + -112 && mouseY > topPos + 52 && mouseY < topPos + 60)
			guiGraphics.renderTooltip(font, Component.translatable("gui.lanternofthewoodlands.spell_4_gu_iweapon_lantern.tooltip_remove_all_active_weapon_in_this"), mouseX, mouseY);
		if (mouseX > leftPos + -108 && mouseX < leftPos + -100 && mouseY > topPos + 52 && mouseY < topPos + 60)
			guiGraphics.renderTooltip(font, Component.translatable("gui.lanternofthewoodlands.spell_4_gu_iweapon_lantern.tooltip_1_count_max_10_mana"), mouseX, mouseY);
		if (mouseX > leftPos + -68 && mouseX < leftPos + -52 && mouseY > topPos + -48 && mouseY < topPos + -32)
			guiGraphics.renderTooltip(font, Component.translatable("gui.lanternofthewoodlands.spell_4_gu_iweapon_lantern.tooltip_hidden_objects_temporary_make"), mouseX, mouseY);
		if (mouseX > leftPos + 8 && mouseX < leftPos + 16 && mouseY > topPos + -56 && mouseY < topPos + -48)
			guiGraphics.renderTooltip(font, Component.translatable("gui.lanternofthewoodlands.spell_4_gu_iweapon_lantern.tooltip_1_level_30_mana"), mouseX, mouseY);
	}
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.lanternofthewoodlands.spell_4_gu_iweapon_lantern.label_false_divination"), -96, -88, -1, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.lanternofthewoodlands.spell_4_gu_iweapon_lantern.label_the_spell_of_astrology"), -136, -16, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.lanternofthewoodlands.spell_4_gu_iweapon_lantern.label_use_all_13_zodiac_cards"), -144, -4, -12829636, false);
		...
		guiGraphics.drawString(this.font, Component.translatable("gui.lanternofthewoodlands.spell_4_gu_iweapon_lantern.label_support_to_all_vanilla_sword_typ"), -144, 20, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.lanternofthewoodlands.spell_4_gu_iweapon_lantern.label_supported"), -144, 8, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.lanternofthewoodlands.spell_4_gu_iweapon_lantern.label_manipulation"), -108, -76, -1, false);
		guiGraphics.drawString(this.font,

				Spell4GUIreturnLanternCountProcedure.execute(entity), -132, 64, -6710887, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.lanternofthewoodlands.spell_4_gu_iweapon_lantern.label_level"), 20, -68, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.lanternofthewoodlands.spell_4_gu_iweapon_lantern.label_upgrades"), 56, -88, -1, false);
		guiGraphics.drawString(this.font,

				Spell4GUIreturnLanternLevelProcedure.execute(entity), 20, -56, -6710887, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.lanternofthewoodlands.spell_4_gu_iweapon_lantern.label_cooldown"), 8, -32, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.lanternofthewoodlands.spell_4_gu_iweapon_lantern.label_duration"), 8, -8, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.lanternofthewoodlands.spell_4_gu_iweapon_lantern.label_damage"), 8, 40, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.lanternofthewoodlands.spell_4_gu_iweapon_lantern.label_10s"), 8, -20, -6710887, false);
		guiGraphics.drawString(this.font,

				Spell4GUIreturnLanternStatusProcedure.execute(entity), 8, 52, -6710887, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.lanternofthewoodlands.spell_4_gu_iweapon_lantern.label_999"), 8, 4, -6710887, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.lanternofthewoodlands.spell_4_gu_iweapon_lantern.label_radius"), 8, 16, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.lanternofthewoodlands.spell_4_gu_iweapon_lantern.label_2"), 8, 28, -6710887, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.lanternofthewoodlands.spell_4_gu_iweapon_lantern.label_lantern"), -144, 32, -12829636, false);
	}
	...
	public void init() {
		...
		imagebutton_symbol_exit = new ImageButton(this.leftPos + 144, this.topPos + 88, 8, 8, 0, 0, 8, new ResourceLocation("lanternofthewoodlands:textures/screens/atlas/imagebutton_symbol_exit.png"), 8, 16, e -> {
			if (true) {
				LanternofthewoodlandsMod.PACKET_HANDLER.sendToServer(new Spell4GUIweaponLanternButtonMessage(0, x, y, z, textstate));
				Spell4GUIweaponLanternButtonMessage.handleButtonAction(entity, 0, x, y, z, textstate);
			}
		});
		...
		imagebutton_icon_home = new ImageButton(this.leftPos + -172, this.topPos + -96, 22, 8, 0, 0, 8, new ResourceLocation("lanternofthewoodlands:textures/screens/atlas/imagebutton_icon_home.png"), 22, 16, e -> {
			if (true) {
				LanternofthewoodlandsMod.PACKET_HANDLER.sendToServer(new Spell4GUIweaponLanternButtonMessage(1, x, y, z, textstate));
				Spell4GUIweaponLanternButtonMessage.handleButtonAction(entity, 1, x, y, z, textstate);
			}
		});
		...
		imagebutton_symbol_previous = new ImageButton(this.leftPos + -160, this.topPos + -12, 8, 8, 0, 0, 8, new ResourceLocation("lanternofthewoodlands:textures/screens/atlas/imagebutton_symbol_previous.png"), 8, 16, e -> {
			if (true) {
				LanternofthewoodlandsMod.PACKET_HANDLER.sendToServer(new Spell4GUIweaponLanternButtonMessage(2, x, y, z, textstate));
				Spell4GUIweaponLanternButtonMessage.handleButtonAction(entity, 2, x, y, z, textstate);
			}
		});
		...
		imagebutton_symbol_next = new ImageButton(this.leftPos + 152, this.topPos + -12, 8, 8, 0, 0, 8, new ResourceLocation("lanternofthewoodlands:textures/screens/atlas/imagebutton_symbol_next.png"), 8, 16, e -> {
			if (true) {
				LanternofthewoodlandsMod.PACKET_HANDLER.sendToServer(new Spell4GUIweaponLanternButtonMessage(3, x, y, z, textstate));
				Spell4GUIweaponLanternButtonMessage.handleButtonAction(entity, 3, x, y, z, textstate);
			}
		});
		...
		imagebutton_symbol_add = new ImageButton(this.leftPos + -132, this.topPos + 52, 8, 8, 0, 0, 8, new ResourceLocation("lanternofthewoodlands:textures/screens/atlas/imagebutton_symbol_add.png"), 8, 16, e -> {
			if (true) {
				LanternofthewoodlandsMod.PACKET_HANDLER.sendToServer(new Spell4GUIweaponLanternButtonMessage(5, x, y, z, textstate));
				Spell4GUIweaponLanternButtonMessage.handleButtonAction(entity, 5, x, y, z, textstate);
			}
		});
		...
		imagebutton_symbol_remove = new ImageButton(this.leftPos + -120, this.topPos + 52, 8, 8, 0, 0, 8, new ResourceLocation("lanternofthewoodlands:textures/screens/atlas/imagebutton_symbol_remove.png"), 8, 16, e -> {
			if (true) {
				LanternofthewoodlandsMod.PACKET_HANDLER.sendToServer(new Spell4GUIweaponLanternButtonMessage(6, x, y, z, textstate));
				Spell4GUIweaponLanternButtonMessage.handleButtonAction(entity, 6, x, y, z, textstate);
			}
		});
		...
		imagebutton_symbol_upgrade = new ImageButton(this.leftPos + -108, this.topPos + 52, 8, 8, 0, 0, 8, new ResourceLocation("lanternofthewoodlands:textures/screens/atlas/imagebutton_symbol_upgrade.png"), 8, 16, e -> {
			if (true) {
				LanternofthewoodlandsMod.PACKET_HANDLER.sendToServer(new Spell4GUIweaponLanternButtonMessage(7, x, y, z, textstate));
				Spell4GUIweaponLanternButtonMessage.handleButtonAction(entity, 7, x, y, z, textstate);
			}
		});
		...
		imagebutton_symbol_upgrade2 = new ImageButton(this.leftPos + 8, this.topPos + -56, 8, 8, 0, 0, 8, new ResourceLocation("lanternofthewoodlands:textures/screens/atlas/imagebutton_symbol_upgrade2.png"), 8, 16, e -> {
			if (true) {
				LanternofthewoodlandsMod.PACKET_HANDLER.sendToServer(new Spell4GUIweaponLanternButtonMessage(9, x, y, z, textstate));
				Spell4GUIweaponLanternButtonMessage.handleButtonAction(entity, 9, x, y, z, textstate);
			}
		});
		...
		imagebutton_icon_spell_lantern_manipulation = new ImageButton(this.leftPos + -100, this.topPos + -48, 16, 16, 0, 0, 16, new ResourceLocation("lanternofthewoodlands:textures/screens/atlas/imagebutton_icon_spell_lantern_manipulation.png"), 16,
				32, e -> {
				});
		guistate.put("button:imagebutton_icon_spell_lantern_manipulation", imagebutton_icon_spell_lantern_manipulation);
		this.addRenderableWidget(imagebutton_icon_spell_lantern_manipulation);
		imagebutton_icon_spell_lantern_light = new ImageButton(this.leftPos + -68, this.topPos + -48, 16, 16, 0, 0, 16, new ResourceLocation("lanternofthewoodlands:textures/screens/atlas/imagebutton_icon_spell_lantern_light.png"), 16, 32, e -> {
		});
		guistate.put("button:imagebutton_icon_spell_lantern_light", imagebutton_icon_spell_lantern_light);
