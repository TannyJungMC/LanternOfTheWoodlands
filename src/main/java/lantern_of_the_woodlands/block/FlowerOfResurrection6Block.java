...
public class FlowerOfResurrection6Block extends LanternOfTheWoodlandsModElements.ModElement {
	@ObjectHolder("lantern_of_the_woodlands:flower_of_resurrection_6")
	public static final Block block = null;

	public FlowerOfResurrection6Block(LanternOfTheWoodlandsModElements instance) {
		super(instance, 528);
	}
