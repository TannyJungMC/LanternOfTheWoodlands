...
import tannyjung.tanscomplexmagic.world.inventory.Spell4GUIweaponAnchorMenu;
import tannyjung.tanscomplexmagic.procedures.*;
import tannyjung.tanscomplexmagic.network.Spell4GUIweaponAnchorButtonMessage;
...
public class Spell4GUIweaponAnchorScreen extends AbstractContainerScreen<Spell4GUIweaponAnchorMenu> implements TanscomplexmagicModScreens.ScreenAccessor {
	...
	private ImageButton imagebutton_icon_spell_lost_anchor;
	private ImageButton imagebutton_icon_spell_anchor_retrieval;
	...
	private static final ResourceLocation texture = ResourceLocation.parse("tanscomplexmagic:textures/screens/spell_4_gu_iweapon_anchor.png");
	...
	public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		if (mouseX > leftPos + -132 && mouseX < leftPos + -124 && mouseY > topPos + 52 && mouseY < topPos + 60) {
			guiGraphics.renderTooltip(font, Component.translatable("gui.tanscomplexmagic.spell_4_gu_iweapon_anchor.tooltip_activate_weapons_on_ground_near1"), mouseX, mouseY);
			customTooltipShown = true;
		}
		if (mouseX > leftPos + -120 && mouseX < leftPos + -112 && mouseY > topPos + 52 && mouseY < topPos + 60) {
			guiGraphics.renderTooltip(font, Component.translatable("gui.tanscomplexmagic.spell_4_gu_iweapon_anchor.tooltip_remove_all_active_weapon_in_this"), mouseX, mouseY);
			customTooltipShown = true;
		}
		if (mouseX > leftPos + 8 && mouseX < leftPos + 16 && mouseY > topPos + -56 && mouseY < topPos + -48) {
			guiGraphics.renderTooltip(font, Component.translatable("gui.tanscomplexmagic.spell_4_gu_iweapon_anchor.tooltip_1_level_30_mana"), mouseX, mouseY);
			customTooltipShown = true;
		}
		if (mouseX > leftPos + -68 && mouseX < leftPos + -52 && mouseY > topPos + -60 && mouseY < topPos + -44) {
			guiGraphics.renderTooltip(font, Component.translatable("gui.tanscomplexmagic.spell_4_gu_iweapon_anchor.tooltip_anchor_retrieval"), mouseX, mouseY);
			customTooltipShown = true;
		}
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.tanscomplexmagic.spell_4_gu_iweapon_anchor.label_false_divination"), -108, -88, -1, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.tanscomplexmagic.spell_4_gu_iweapon_anchor.label_the_spell_of_astrology"), -136, -28, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.tanscomplexmagic.spell_4_gu_iweapon_anchor.label_use_all_13_zodiac_cards"), -144, -16, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.tanscomplexmagic.spell_4_gu_iweapon_anchor.label_goods_and_bad_effects"), -144, -4, -12829636, false);
		...
		guiGraphics.drawString(this.font, Spell4GUIreturnAnchorCountProcedure.execute(entity), -132, 64, -6710887, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.tanscomplexmagic.spell_4_gu_iweapon_anchor.label_level"), 20, -68, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.tanscomplexmagic.spell_4_gu_iweapon_anchor.label_upgrades"), 56, -88, -1, false);
		guiGraphics.drawString(this.font, Spell4GUIreturnAnchorLevelProcedure.execute(entity), 20, -56, -6710887, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.tanscomplexmagic.spell_4_gu_iweapon_anchor.label_cooldown"), 8, -32, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.tanscomplexmagic.spell_4_gu_iweapon_anchor.label_duration"), 8, -8, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.tanscomplexmagic.spell_4_gu_iweapon_anchor.label_damage"), 8, 40, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.tanscomplexmagic.spell_4_gu_iweapon_anchor.label_10s"), 8, -20, -6710887, false);
		guiGraphics.drawString(this.font, Spell4GUIreturnAnchorStatusProcedure.execute(entity), 8, 52, -6710887, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.tanscomplexmagic.spell_4_gu_iweapon_anchor.label_999"), 8, 4, -6710887, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.tanscomplexmagic.spell_4_gu_iweapon_anchor.label_radius"), 8, 16, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.tanscomplexmagic.spell_4_gu_iweapon_anchor.label_2"), 8, 28, -6710887, false);
	}
	...
	public void init() {
		...
		imagebutton_symbol_exit = new ImageButton(this.leftPos + 144, this.topPos + 88, 8, 8,
				new WidgetSprites(ResourceLocation.parse("tanscomplexmagic:textures/screens/symbol_exit.png"), ResourceLocation.parse("tanscomplexmagic:textures/screens/symbol_exit.png")), e -> {
					int x = Spell4GUIweaponAnchorScreen.this.x;
					int y = Spell4GUIweaponAnchorScreen.this.y;
					if (true) {
						PacketDistributor.sendToServer(new Spell4GUIweaponAnchorButtonMessage(0, x, y, z));
						Spell4GUIweaponAnchorButtonMessage.handleButtonAction(entity, 0, x, y, z);
					}
				}) {
			@Override
		...
		imagebutton_icon_home = new ImageButton(this.leftPos + -172, this.topPos + -96, 22, 8,
				new WidgetSprites(ResourceLocation.parse("tanscomplexmagic:textures/screens/icon_home.png"), ResourceLocation.parse("tanscomplexmagic:textures/screens/icon_home_2s.png")), e -> {
					...
					int y = Spell4GUIweaponAnchorScreen.this.y;
					if (true) {
						PacketDistributor.sendToServer(new Spell4GUIweaponAnchorButtonMessage(1, x, y, z));
						Spell4GUIweaponAnchorButtonMessage.handleButtonAction(entity, 1, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		imagebutton_symbol_previous = new ImageButton(this.leftPos + -160, this.topPos + -12, 8, 8,
				new WidgetSprites(ResourceLocation.parse("tanscomplexmagic:textures/screens/symbol_previous.png"), ResourceLocation.parse("tanscomplexmagic:textures/screens/symbol_previous.png")), e -> {
					...
					int y = Spell4GUIweaponAnchorScreen.this.y;
					if (true) {
						PacketDistributor.sendToServer(new Spell4GUIweaponAnchorButtonMessage(2, x, y, z));
						Spell4GUIweaponAnchorButtonMessage.handleButtonAction(entity, 2, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		imagebutton_symbol_next = new ImageButton(this.leftPos + 152, this.topPos + -12, 8, 8,
				new WidgetSprites(ResourceLocation.parse("tanscomplexmagic:textures/screens/symbol_next.png"), ResourceLocation.parse("tanscomplexmagic:textures/screens/symbol_next.png")), e -> {
					...
					int y = Spell4GUIweaponAnchorScreen.this.y;
					if (true) {
						PacketDistributor.sendToServer(new Spell4GUIweaponAnchorButtonMessage(3, x, y, z));
						Spell4GUIweaponAnchorButtonMessage.handleButtonAction(entity, 3, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		imagebutton_symbol_add = new ImageButton(this.leftPos + -132, this.topPos + 52, 8, 8,
				new WidgetSprites(ResourceLocation.parse("tanscomplexmagic:textures/screens/symbol_add.png"), ResourceLocation.parse("tanscomplexmagic:textures/screens/symbol_add.png")), e -> {
					...
					int y = Spell4GUIweaponAnchorScreen.this.y;
					if (true) {
						PacketDistributor.sendToServer(new Spell4GUIweaponAnchorButtonMessage(4, x, y, z));
						Spell4GUIweaponAnchorButtonMessage.handleButtonAction(entity, 4, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		imagebutton_symbol_remove = new ImageButton(this.leftPos + -120, this.topPos + 52, 8, 8,
				new WidgetSprites(ResourceLocation.parse("tanscomplexmagic:textures/screens/symbol_remove.png"), ResourceLocation.parse("tanscomplexmagic:textures/screens/symbol_remove.png")), e -> {
					...
					int y = Spell4GUIweaponAnchorScreen.this.y;
					if (true) {
						PacketDistributor.sendToServer(new Spell4GUIweaponAnchorButtonMessage(5, x, y, z));
						Spell4GUIweaponAnchorButtonMessage.handleButtonAction(entity, 5, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		imagebutton_symbol_upgrade2 = new ImageButton(this.leftPos + 8, this.topPos + -56, 8, 8,
				new WidgetSprites(ResourceLocation.parse("tanscomplexmagic:textures/screens/symbol_upgrade.png"), ResourceLocation.parse("tanscomplexmagic:textures/screens/symbol_upgrade.png")), e -> {
					...
					int y = Spell4GUIweaponAnchorScreen.this.y;
					if (true) {
						PacketDistributor.sendToServer(new Spell4GUIweaponAnchorButtonMessage(7, x, y, z));
						Spell4GUIweaponAnchorButtonMessage.handleButtonAction(entity, 7, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		imagebutton_background_icon1 = new ImageButton(this.leftPos + -72, this.topPos + -64, 24, 24,
		...
		imagebutton_background_icon = new ImageButton(this.leftPos + -104, this.topPos + -64, 24, 24,
				new WidgetSprites(ResourceLocation.parse("tanscomplexmagic:textures/screens/background_icon.png"), ResourceLocation.parse("tanscomplexmagic:textures/screens/background_icon.png")), e -> {
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		imagebutton_icon_spell_lost_anchor = new ImageButton(this.leftPos + -100, this.topPos + -60, 16, 16,
				new WidgetSprites(ResourceLocation.parse("tanscomplexmagic:textures/screens/icon_spell_lost_anchor.png"), ResourceLocation.parse("tanscomplexmagic:textures/screens/icon_spell_lost_anchor.png")), e -> {
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
				guiGraphics.blit(sprites.get(isActive(), isHoveredOrFocused()), getX(), getY(), 0, 0, width, height, width, height);
		...
		imagebutton_icon_spell_anchor_retrieval = new ImageButton(this.leftPos + -68, this.topPos + -60, 16, 16,
				new WidgetSprites(ResourceLocation.parse("tanscomplexmagic:textures/screens/icon_spell_anchor_retrieval.png"), ResourceLocation.parse("tanscomplexmagic:textures/screens/icon_spell_anchor_retrieval.png")), e -> {
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
				guiGraphics.blit(sprites.get(isActive(), isHoveredOrFocused()), getX(), getY(), 0, 0, width, height, width, height);
