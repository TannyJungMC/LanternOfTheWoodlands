...
public class ImaginaryShieldItem extends LanternOfTheWoodlandsModElements.ModElement {
	@ObjectHolder("lantern_of_the_woodlands:imaginary_shield")
	public static final Item block = null;

	public ImaginaryShieldItem(LanternOfTheWoodlandsModElements instance) {
		super(instance, 438);
	}
	...
	public void initElements() {
		elements.items.add(() -> new SwordItem(new IItemTier() {
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("> blocking arrow and melee damage in area"));
				list.add(new StringTextComponent("--------------------"));
			}
		}.setRegistryName("imaginary_shield"));
	}
}
