...
public class FlowerOfResurrection2Block extends LanternOfTheWoodlandsModElements.ModElement {
	@ObjectHolder("lantern_of_the_woodlands:flower_of_resurrection_2")
	public static final Block block = null;

	public FlowerOfResurrection2Block(LanternOfTheWoodlandsModElements instance) {
		super(instance, 524);
	}
