...
public class ManInTheMirrorItem extends LanternOfTheWoodlandsModElements.ModElement {
	@ObjectHolder("lantern_of_the_woodlands:man_in_the_mirror")
	public static final Item block = null;

	public ManInTheMirrorItem(LanternOfTheWoodlandsModElements instance) {
		super(instance, 435);
	}
	...
	public void initElements() {
		elements.items.add(() -> new SwordItem(new IItemTier() {
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("> stop walking in area"));
				list.add(new StringTextComponent("--------------------"));
			}
		}.setRegistryName("man_in_the_mirror"));
	}
}
