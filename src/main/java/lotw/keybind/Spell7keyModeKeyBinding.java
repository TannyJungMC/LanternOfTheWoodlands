...
import lotw.procedures.Spell7keyModeRunProcedure;
...
public class Spell7keyModeKeyBinding extends LotwModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public Spell7keyModeKeyBinding(LotwModElements instance) {
		super(instance, 981);
	...
	public void initElements() {
		keys = new KeyBinding("key.lotw.spell_7key_mode", GLFW.GLFW_KEY_6, "key.categories.lotw");
