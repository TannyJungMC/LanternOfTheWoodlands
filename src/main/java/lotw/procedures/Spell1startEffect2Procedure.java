...
public class Spell1startEffect2Procedure {

	public static boolean executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				LotwMod.LOGGER.warn("Failed to load dependency world for procedure Spell1startEffect2!");
			return false;
		}
		IWorld world = (IWorld) dependencies.get("world");
		String effect = "";
		effect = "2";
		return LotwModVariables.MapVariables.get(world).spell1_start_effect2 == true
