...
public class Spell4GUIButtonMessage {
	private final int buttonID, x, y, z;
	private HashMap<String, String> textstate;

	public Spell4GUIButtonMessage(FriendlyByteBuf buffer) {
	...
	public Spell4GUIButtonMessage(int buttonID, int x, int y, int z, HashMap<String, String> textstate) {
	...
	public static void buffer(Spell4GUIButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(Spell4GUIButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z, HashMap<String, String> textstate) {
		...
		HashMap guistate = Spell4GUIMenu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		LanternofthewoodlandsMod.addNetworkMessage(Spell4GUIButtonMessage.class, Spell4GUIButtonMessage::buffer, Spell4GUIButtonMessage::new, Spell4GUIButtonMessage::handler);
	}
