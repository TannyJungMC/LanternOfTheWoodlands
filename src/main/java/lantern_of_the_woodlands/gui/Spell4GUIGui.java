...
import lantern_of_the_woodlands.procedures.Spell4clickRESETProcedure;
import lantern_of_the_woodlands.procedures.Spell4cancelProcedure;
import lantern_of_the_woodlands.procedures.Spell4GUItestProcedure;
import lantern_of_the_woodlands.procedures.Spell4GUItest8Procedure;
import lantern_of_the_woodlands.procedures.Spell4GUItest7Procedure;
import lantern_of_the_woodlands.procedures.Spell4GUItest6Procedure;
import lantern_of_the_woodlands.procedures.Spell4GUItest5Procedure;
import lantern_of_the_woodlands.procedures.Spell4GUItest4Procedure;
import lantern_of_the_woodlands.procedures.Spell4GUItest3Procedure;
import lantern_of_the_woodlands.procedures.Spell4GUItest2Procedure;
import lantern_of_the_woodlands.procedures.Spell4GUIcheckTESTProcedure;
...
public class Spell4GUIGui extends LanternOfTheWoodlandsModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;

	public Spell4GUIGui(LanternOfTheWoodlandsModElements instance) {
		super(instance, 349);
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("spell_4_gui"));
		}
	}

	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, Spell4GUIGuiWindow::new));
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			this.customSlots.put(6, this.addSlot(new SlotItemHandler(internal, 6, 106, 62) {
				@Override
				public void onSlotChanged() {
					super.onSlotChanged();
			...
			this.customSlots.put(7, this.addSlot(new SlotItemHandler(internal, 7, 124, 62) {
				@Override
				public void onSlotChanged() {
					super.onSlotChanged();
			...
			this.customSlots.put(8, this.addSlot(new SlotItemHandler(internal, 8, 142, 62) {
				@Override
				public void onSlotChanged() {
					super.onSlotChanged();
	...
	static void handleButtonAction(PlayerEntity entity, int buttonID, int x, int y, int z) {
		...
		if (buttonID == 1) {
			...
			Spell4cancelProcedure.executeProcedure(Stream
		...
		if (buttonID == 2) {
			...
			Spell4clickRESETProcedure.executeProcedure(Stream
					.of(new AbstractMap.SimpleEntry<>("world", world), new AbstractMap.SimpleEntry<>("x", x), new AbstractMap.SimpleEntry<>("y", y),
							new AbstractMap.SimpleEntry<>("z", z), new AbstractMap.SimpleEntry<>("entity", entity))
					.collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
		}
	...
	private static void handleSlotAction(PlayerEntity entity, int slotID, int changeType, int meta, int x, int y, int z) {
		...
		if (slotID == 5 && changeType == 0) {
			...
			Spell4GUItest5Procedure.executeProcedure(Stream
					.of(new AbstractMap.SimpleEntry<>("world", world), new AbstractMap.SimpleEntry<>("x", x), new AbstractMap.SimpleEntry<>("y", y),
							new AbstractMap.SimpleEntry<>("z", z), new AbstractMap.SimpleEntry<>("entity", entity))
					.collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
		}
		if (slotID == 6 && changeType == 0) {
			...
			Spell4GUItest6Procedure.executeProcedure(Stream
					.of(new AbstractMap.SimpleEntry<>("world", world), new AbstractMap.SimpleEntry<>("x", x), new AbstractMap.SimpleEntry<>("y", y),
							new AbstractMap.SimpleEntry<>("z", z), new AbstractMap.SimpleEntry<>("entity", entity))
					.collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
		}
