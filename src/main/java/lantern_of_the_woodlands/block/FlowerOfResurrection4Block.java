...
public class FlowerOfResurrection4Block extends LanternOfTheWoodlandsModElements.ModElement {
	@ObjectHolder("lantern_of_the_woodlands:flower_of_resurrection_4")
	public static final Block block = null;

	public FlowerOfResurrection4Block(LanternOfTheWoodlandsModElements instance) {
		super(instance, 526);
	}
