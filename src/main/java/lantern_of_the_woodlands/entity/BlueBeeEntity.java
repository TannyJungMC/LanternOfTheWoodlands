...
package lantern_of_the_woodlands.entity;
...
import lantern_of_the_woodlands.procedures.BasicSpell7whenDieProcedure;

import lantern_of_the_woodlands.itemgroup.TabItemGroup;

import lantern_of_the_woodlands.entity.renderer.BlueBeeRenderer;
...
public class BlueBeeEntity extends LanternOfTheWoodlandsModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.4f, 0.7f)).build("blue_bee").setRegistryName("blue_bee");

	public BlueBeeEntity(LanternOfTheWoodlandsModElements instance) {
		super(instance, 560);
		FMLJavaModLoadingContext.get().getModEventBus().register(new BlueBeeRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -1, -3355444, new Item.Properties().group(TabItemGroup.tab)).setRegistryName("blue_bee_spawn_egg"));
	}
	...
	public static class CustomEntity extends CreatureEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			setNoAI(false);
			enablePersistence();
			this.setItemStackToSlot(EquipmentSlotType.MAINHAND, new ItemStack(Blocks.GLOWSTONE));
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(5, new RandomWalkingGoal(this, 0.5, 20) {
				@Override
		...
		public void playStepSound(BlockPos pos, BlockState blockIn) {
			this.playSound((net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.bee.loop_aggressive")),
					0.15f, 1);
		}
