...
public class KnightSwordItem extends LanternOfTheWoodlandsModElements.ModElement {
	@ObjectHolder("lantern_of_the_woodlands:knight_sword")
	public static final Item block = null;

	public KnightSwordItem(LanternOfTheWoodlandsModElements instance) {
		super(instance, 433);
	}
