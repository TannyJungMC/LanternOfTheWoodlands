...
import lantern_of_the_woodlands.procedures.BasicSpell11whenPlaceProcedure;
import lantern_of_the_woodlands.procedures.BasicSpell11tickProcedure;
...
public class StoneTotemBlockBlock extends LanternOfTheWoodlandsModElements.ModElement {
	@ObjectHolder("lantern_of_the_woodlands:stone_totem_block")
	public static final Block block = null;

	public StoneTotemBlockBlock(LanternOfTheWoodlandsModElements instance) {
		super(instance, 534);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("stone_totem_block");
		}
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("> make area in 100x100 block always active"));
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			BasicSpell11tickProcedure.executeProcedure(Stream
		...
		public void onBlockPlacedBy(World world, BlockPos pos, BlockState blockstate, LivingEntity entity, ItemStack itemstack) {
			...
			BasicSpell11whenPlaceProcedure.executeProcedure(Stream
					.of(new AbstractMap.SimpleEntry<>("world", world), new AbstractMap.SimpleEntry<>("x", x), new AbstractMap.SimpleEntry<>("y", y),
							new AbstractMap.SimpleEntry<>("z", z))
					.collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
		}
