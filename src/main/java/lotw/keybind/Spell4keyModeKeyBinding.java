...
import lotw.procedures.Spell4keyModeRUNProcedure;
...
public class Spell4keyModeKeyBinding extends LotwModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public Spell4keyModeKeyBinding(LotwModElements instance) {
		super(instance, 804);
	...
	public void initElements() {
		keys = new KeyBinding("key.lotw.spell_4key_mode", GLFW.GLFW_KEY_2, "key.categories.lotw");
