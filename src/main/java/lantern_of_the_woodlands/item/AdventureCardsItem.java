...
public class AdventureCardsItem extends LanternOfTheWoodlandsModElements.ModElement {
	@ObjectHolder("lantern_of_the_woodlands:adventure_cards")
	public static final Item block = null;

	public AdventureCardsItem(LanternOfTheWoodlandsModElements instance) {
		super(instance, 439);
	}
	...
	public void initElements() {
		elements.items.add(() -> new SwordItem(new IItemTier() {
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("> random effect while reload"));
				list.add(new StringTextComponent("--------------------"));
			}
		}.setRegistryName("adventure_cards"));
	}
}
