...
public class Spell7keyNextKeyBinding extends LotwModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public Spell7keyNextKeyBinding(LotwModElements instance) {
		super(instance, 928);
	...
	public void initElements() {
		keys = new KeyBinding("key.lotw.spell_7key_next", GLFW.GLFW_KEY_2, "key.categories.lotw");
