...
import lotw.procedures.IllusionGrassWhenPlaceProcedure;
...
public class IllusionGrassBlock extends LotwModElements.ModElement {
	@ObjectHolder("lotw:illusion_grass")
	public static final Block block = null;

	public IllusionGrassBlock(LotwModElements instance) {
		super(instance, 587);
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("illusion_grass");
		}
		...
		public void onBlockPlacedBy(World world, BlockPos pos, BlockState blockstate, LivingEntity entity, ItemStack itemstack) {
			...
			IllusionGrassWhenPlaceProcedure.executeProcedure(Stream
