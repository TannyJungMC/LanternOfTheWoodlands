...
public class FlowerOfResurrection7Block extends LanternOfTheWoodlandsModElements.ModElement {
	@ObjectHolder("lantern_of_the_woodlands:flower_of_resurrection_7")
	public static final Block block = null;

	public FlowerOfResurrection7Block(LanternOfTheWoodlandsModElements instance) {
		super(instance, 529);
	}
