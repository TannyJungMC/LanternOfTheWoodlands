...
public class Spell4GUI2ButtonMessage {
	private final int buttonID, x, y, z;
	private HashMap<String, String> textstate;

	public Spell4GUI2ButtonMessage(FriendlyByteBuf buffer) {
	...
	public Spell4GUI2ButtonMessage(int buttonID, int x, int y, int z, HashMap<String, String> textstate) {
	...
	public static void buffer(Spell4GUI2ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(Spell4GUI2ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z, HashMap<String, String> textstate) {
		...
		HashMap guistate = Spell4GUI2Menu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		LanternofthewoodlandsMod.addNetworkMessage(Spell4GUI2ButtonMessage.class, Spell4GUI2ButtonMessage::buffer, Spell4GUI2ButtonMessage::new, Spell4GUI2ButtonMessage::handler);
	}
