...
public class Spell4effectProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (!("Sword").equals("")) {
			if (true) {
				if (((entity.getData(TanscomplexmagicModVariables.PLAYER_VARIABLES).spell4_type).equals("All") || (entity.getData(TanscomplexmagicModVariables.PLAYER_VARIABLES).spell4_type).equals("Sword"))
						&& entity.getData(TanscomplexmagicModVariables.PLAYER_VARIABLES).spell4_weapon_sword_count != 0) {
								...
								if (world instanceof ServerLevel _level)
									_level.getServer().getCommands().performPrefixedCommand(
											...
											(("execute at @e[nbt={ArmorItems:[{id:\"" + "minecraft:wooden_sword"
													...
													+ variable_number * 1 + " minecraft:player_attack by @p[tag=<ID>-user]").replace("<ID>", entity.getData(TanscomplexmagicModVariables.PLAYER_VARIABLES).user_DELETE_THIS)));
								if (world instanceof ServerLevel _level)
									_level.getServer().getCommands().performPrefixedCommand(
											new CommandSourceStack(CommandSource.NULL, new Vec3(x, y, z), Vec2.ZERO, _level, 4, "", Component.literal(""), _level.getServer(), null).withSuppressedOutput(),
								...
								if (world instanceof ServerLevel _level)
									_level.getServer().getCommands().performPrefixedCommand(
											...
											(("execute at @e[nbt={ArmorItems:[{id:\"" + "minecraft:iron_sword"
													+ "\",Count:1b},{},{},{}]},tag=<ID>-spell4_sword,tag=!<ID>-spell4_hit,tag=<ID>-spell4_shoot] positioned ~ ~1.4 ~ positioned ^-0.4 ^-0.45 ^0.9 as @e[type=!#lotw:spell4_attack_blacklist,tag=!<ID>-ally,distance=..4] at @s run damage @s "
													+ variable_number * 2 + " minecraft:player_attack by @p[tag=<ID>-user]").replace("<ID>", entity.getData(TanscomplexmagicModVariables.PLAYER_VARIABLES).user_DELETE_THIS)));
								if (world instanceof ServerLevel _level)
									_level.getServer().getCommands().performPrefixedCommand(
											new CommandSourceStack(CommandSource.NULL, new Vec3(x, y, z), Vec2.ZERO, _level, 4, "", Component.literal(""), _level.getServer(), null).withSuppressedOutput(),
								...
								if (world instanceof ServerLevel _level)
									_level.getServer().getCommands().performPrefixedCommand(
											...
											(("execute at @e[nbt={ArmorItems:[{id:\"" + "minecraft:diamond_sword"
													+ "\",Count:1b},{},{},{}]},tag=<ID>-spell4_sword,tag=!<ID>-spell4_hit,tag=<ID>-spell4_shoot] positioned ~ ~1.4 ~ positioned ^-0.4 ^-0.45 ^0.9 as @e[type=!#lotw:spell4_attack_blacklist,tag=!<ID>-ally,distance=..4] at @s run damage @s "
													+ variable_number * 3 + " minecraft:player_attack by @p[tag=<ID>-user]").replace("<ID>", entity.getData(TanscomplexmagicModVariables.PLAYER_VARIABLES).user_DELETE_THIS)));
								if (world instanceof ServerLevel _level)
									_level.getServer().getCommands().performPrefixedCommand(
											new CommandSourceStack(CommandSource.NULL, new Vec3(x, y, z), Vec2.ZERO, _level, 4, "", Component.literal(""), _level.getServer(), null).withSuppressedOutput(),
											(("execute at @e[nbt={ArmorItems:[{id:\"" + "minecraft:netherite_sword"
													+ "\",Count:1b},{},{},{}]},tag=<ID>-spell4_sword,tag=!<ID>-spell4_hit,tag=<ID>-spell4_shoot] positioned ~ ~1.4 ~ positioned ^-0.4 ^-0.45 ^0.9 as @e[type=!#lotw:spell4_attack_blacklist,tag=!<ID>-ally,distance=..4] at @s run damage @s "
													+ variable_number * 5 + " minecraft:player_attack by @p[tag=<ID>-user]").replace("<ID>", entity.getData(TanscomplexmagicModVariables.PLAYER_VARIABLES).user_DELETE_THIS)));
							}
						}
					}
				}
		...
		if (!("Shield").equals("")) {
			if (true) {
					...
					if (world instanceof ServerLevel _level)
						_level.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL, new Vec3(x, y, z), Vec2.ZERO, _level, 4, "", Component.literal(""), _level.getServer(), null).withSuppressedOutput(),
								(("execute as @e[tag=<ID>-spell4_shield] at @s run summon armor_stand ~ ~ ~ {Tags:[" + "\"LOTW\",\"<ID>\",\"<ID>-ally\",\"<ID>-spell4\""
										+ "],NoGravity:1b,Invisible:1b,Silent:1b,CustomName:'{\"text\":\"<ID>-spell4_shield_blocker\"}'}").replace("<ID>", entity.getData(TanscomplexmagicModVariables.PLAYER_VARIABLES).user_DELETE_THIS)));
					if (world instanceof ServerLevel _level)
						_level.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL, new Vec3(x, y, z), Vec2.ZERO, _level, 4, "", Component.literal(""), _level.getServer(), null).withSuppressedOutput(),
				...
				if (entity.getData(TanscomplexmagicModVariables.PLAYER_VARIABLES).spell4_ability_duration >= 0 && (entity.getData(TanscomplexmagicModVariables.PLAYER_VARIABLES).spell4_ability).equals("Shield")) {
					if (world instanceof ServerLevel _level)
						_level.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL, new Vec3(x, y, z), Vec2.ZERO, _level, 4, "", Component.literal(""), _level.getServer(), null).withSuppressedOutput(),
								("execute as @e[tag=<ID>-spell4_shield] at @s run data merge entity @s {Pose:{RightArm:[0f,0f,-90f]}}".replace("<ID>", entity.getData(TanscomplexmagicModVariables.PLAYER_VARIABLES).user_DELETE_THIS)));
					if (world instanceof ServerLevel _level)
						_level.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL, new Vec3(x, y, z), Vec2.ZERO, _level, 4, "", Component.literal(""), _level.getServer(), null).withSuppressedOutput(),
		...
		if (!("Lantern").equals("")) {
			if (true) {
				if (entity.getData(TanscomplexmagicModVariables.PLAYER_VARIABLES).spell4_weapon_lantern_count != 0) {
					if (world instanceof ServerLevel _level)
						_level.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL, new Vec3(x, y, z), Vec2.ZERO, _level, 4, "", Component.literal(""), _level.getServer(), null).withSuppressedOutput(),
								("effect give @e[name=<ID>-spell4_lantern_light] invisibility 1000000 1 true".replace("<ID>", entity.getData(TanscomplexmagicModVariables.PLAYER_VARIABLES).user_DELETE_THIS)));
					if (world instanceof ServerLevel _level)
						_level.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL, new Vec3(x, y, z), Vec2.ZERO, _level, 4, "", Component.literal(""), _level.getServer(), null).withSuppressedOutput(),
								("execute at @e[name=<ID>-spell4_lantern_light] run particle minecraft:flame ~ ~0.4 ~ 0 0 0 0 1 force".replace("<ID>", entity.getData(TanscomplexmagicModVariables.PLAYER_VARIABLES).user_DELETE_THIS)));
					if (world instanceof ServerLevel _level)
						_level.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL, new Vec3(x, y, z), Vec2.ZERO, _level, 4, "", Component.literal(""), _level.getServer(), null).withSuppressedOutput(),
					...
					if (world instanceof ServerLevel _level)
						_level.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL, new Vec3(x, y, z), Vec2.ZERO, _level, 4, "", Component.literal(""), _level.getServer(), null).withSuppressedOutput(),
								(("execute at @e[name=<ID>-spell4_lantern_light] as @e[tag=!<ID>-ally,distance=..1] at @s run data merge entity @s {Fire:"
										+ 20 * entity.getData(TanscomplexmagicModVariables.PLAYER_VARIABLES).spell4_weapon_lantern_level + "}").replace("<ID>", entity.getData(TanscomplexmagicModVariables.PLAYER_VARIABLES).user_DELETE_THIS)));
					if (world instanceof ServerLevel _level)
						_level.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL, new Vec3(x, y, z), Vec2.ZERO, _level, 4, "", Component.literal(""), _level.getServer(), null).withSuppressedOutput(),
								("execute as @e[name=<ID>-spell4_lantern_light] at @s if entity @e[tag=!<ID>-ally,distance=..1] run kill @s".replace("<ID>", entity.getData(TanscomplexmagicModVariables.PLAYER_VARIABLES).user_DELETE_THIS)));
				}
			}
		}
		if (!("Anchor").equals("")) {
			if (true) {
				if (((entity.getData(TanscomplexmagicModVariables.PLAYER_VARIABLES).spell4_type).equals("All") || (entity.getData(TanscomplexmagicModVariables.PLAYER_VARIABLES).spell4_type).equals("Anchor"))
		...
		if (!("Knight's Sword").equals("")) {
			if (true) {
				if (((entity.getData(TanscomplexmagicModVariables.PLAYER_VARIABLES).spell4_type).equals("All") || (entity.getData(TanscomplexmagicModVariables.PLAYER_VARIABLES).spell4_type).equals("Knight's Sword"))
						&& entity.getData(TanscomplexmagicModVariables.PLAYER_VARIABLES).spell4_weapon_knight_sword_count != 0) {
					if (world instanceof ServerLevel _level)
						_level.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL, new Vec3(x, y, z), Vec2.ZERO, _level, 4, "", Component.literal(""), _level.getServer(), null).withSuppressedOutput(),
								...
								if (world instanceof ServerLevel _level)
									_level.getServer().getCommands().performPrefixedCommand(
											...
											(("execute at @e[tag=<ID>-spell4_" + "knight_sword"
													...
													+ variable_number + " minecraft:player_attack by @p[tag=<ID>-user]").replace("<ID>", entity.getData(TanscomplexmagicModVariables.PLAYER_VARIABLES).user_DELETE_THIS)));
							}
						}
					}
				}
