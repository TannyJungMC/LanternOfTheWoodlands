...
import lotw.procedures.Spell5checkShowTrapProcedure;
import lotw.procedures.Spell5checkPauseTrueProcedure;
import lotw.procedures.Spell5checkPauseFALSEProcedure;
import lotw.procedures.Spell5checkAlwayGenTRUEProcedure;
...
public class Spell5GUIGuiWindow extends ContainerScreen<Spell5GUIGui.GuiContainerMod> {
	...
	protected void drawGuiContainerBackgroundLayer(MatrixStack ms, float partialTicks, int gx, int gy) {
		...
		Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("lotw:textures/screens/spell2.png"));
		this.blit(ms, this.guiLeft + -63, this.guiTop + -96, 0, 0, 16, 16, 16, 16);

		Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("lotw:textures/screens/spell5.png"));
	...
	public void init(Minecraft minecraft, int width, int height) {
		...
		this.addButton(new Button(this.guiLeft + 160, this.guiTop + 72, 48, 20, new StringTextComponent("Back"), e -> {
			if (true) {
				LotwMod.PACKET_HANDLER.sendToServer(new Spell5GUIGui.ButtonPressedMessage(0, x, y, z));
		...
		this.addButton(new Button(this.guiLeft + -79, this.guiTop + 72, 88, 20, new StringTextComponent("Cancel Spell"), e -> {
			if (true) {
				LotwMod.PACKET_HANDLER.sendToServer(new Spell5GUIGui.ButtonPressedMessage(1, x, y, z));
		...
		this.addButton(new Button(this.guiLeft + 124, this.guiTop + 24, 36, 20, new StringTextComponent("Save"), e -> {
			if (true) {
				LotwMod.PACKET_HANDLER.sendToServer(new Spell5GUIGui.ButtonPressedMessage(2, x, y, z));
		...
		this.addButton(new Button(this.guiLeft + -63, this.guiTop + 36, 52, 20, new StringTextComponent("Start"), e -> {
			if (true) {
				LotwMod.PACKET_HANDLER.sendToServer(new Spell5GUIGui.ButtonPressedMessage(3, x, y, z));
		...
		this.addButton(new Button(this.guiLeft + -11, this.guiTop + 36, 52, 20, new StringTextComponent("Remove"), e -> {
			if (true) {
				LotwMod.PACKET_HANDLER.sendToServer(new Spell5GUIGui.ButtonPressedMessage(4, x, y, z));
		...
		this.addButton(new Button(this.guiLeft + -107, this.guiTop + -20, 24, 20, new StringTextComponent("Use"), e -> {
			if (true) {
				LotwMod.PACKET_HANDLER.sendToServer(new Spell5GUIGui.ButtonPressedMessage(5, x, y, z));
		...
		this.addButton(new Button(this.guiLeft + -107, this.guiTop + 0, 24, 20, new StringTextComponent("Use"), e -> {
			if (true) {
				LotwMod.PACKET_HANDLER.sendToServer(new Spell5GUIGui.ButtonPressedMessage(6, x, y, z));
		...
		this.addButton(new Button(this.guiLeft + -107, this.guiTop + -100, 24, 20, new StringTextComponent("Use"), e -> {
			if (true) {
				LotwMod.PACKET_HANDLER.sendToServer(new Spell5GUIGui.ButtonPressedMessage(7, x, y, z));
		...
		this.addButton(new Button(this.guiLeft + 160, this.guiTop + 24, 32, 20, new StringTextComponent("Clear"), e -> {
			if (true) {
				LotwMod.PACKET_HANDLER.sendToServer(new Spell5GUIGui.ButtonPressedMessage(8, x, y, z));
		...
		this.addButton(new Button(this.guiLeft + -107, this.guiTop + -40, 24, 20, new StringTextComponent("Use"), e -> {
			if (true) {
				LotwMod.PACKET_HANDLER.sendToServer(new Spell5GUIGui.ButtonPressedMessage(9, x, y, z));
				Spell5GUIGui.handleButtonAction(entity, 9, x, y, z);
			}
		}));
		this.addButton(new Button(this.guiLeft + -107, this.guiTop + 20, 24, 20, new StringTextComponent("Use"), e -> {
			if (true) {
				LotwMod.PACKET_HANDLER.sendToServer(new Spell5GUIGui.ButtonPressedMessage(10, x, y, z));
		...
		this.addButton(new Button(this.guiLeft + -107, this.guiTop + -80, 24, 20, new StringTextComponent("Use"), e -> {
			if (true) {
				LotwMod.PACKET_HANDLER.sendToServer(new Spell5GUIGui.ButtonPressedMessage(11, x, y, z));
		...
		this.addButton(new Button(this.guiLeft + -107, this.guiTop + -60, 24, 20, new StringTextComponent("Use"), e -> {
			if (true) {
				LotwMod.PACKET_HANDLER.sendToServer(new Spell5GUIGui.ButtonPressedMessage(12, x, y, z));
				Spell5GUIGui.handleButtonAction(entity, 12, x, y, z);
			}
		}));
		this.addButton(new Button(this.guiLeft + -107, this.guiTop + 40, 24, 20, new StringTextComponent("Use"), e -> {
			if (true) {
				LotwMod.PACKET_HANDLER.sendToServer(new Spell5GUIGui.ButtonPressedMessage(13, x, y, z));
		...
		this.addButton(new Button(this.guiLeft + 44, this.guiTop + 36, 8, 20, new StringTextComponent("="), e -> {
			if (Spell5checkPauseFALSEProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("world", world)).collect(HashMap::new,
					(_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll))) {
				LotwMod.PACKET_HANDLER.sendToServer(new Spell5GUIGui.ButtonPressedMessage(14, x, y, z));
		...
		this.addButton(new Button(this.guiLeft + 52, this.guiTop + 36, 8, 20, new StringTextComponent(">"), e -> {
			if (Spell5checkPauseTrueProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("world", world)).collect(HashMap::new,
					(_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll))) {
				LotwMod.PACKET_HANDLER.sendToServer(new Spell5GUIGui.ButtonPressedMessage(15, x, y, z));
		...
		this.addButton(new Button(this.guiLeft + 44, this.guiTop + 36, 8, 20, new StringTextComponent(" "), e -> {
			if (Spell5checkPauseTrueProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("world", world)).collect(HashMap::new,
					(_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll))) {
				LotwMod.PACKET_HANDLER.sendToServer(new Spell5GUIGui.ButtonPressedMessage(16, x, y, z));
		...
		this.addButton(new Button(this.guiLeft + 52, this.guiTop + 36, 8, 20, new StringTextComponent(" "), e -> {
			if (Spell5checkPauseFALSEProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("world", world)).collect(HashMap::new,
					(_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll))) {
				LotwMod.PACKET_HANDLER.sendToServer(new Spell5GUIGui.ButtonPressedMessage(17, x, y, z));
