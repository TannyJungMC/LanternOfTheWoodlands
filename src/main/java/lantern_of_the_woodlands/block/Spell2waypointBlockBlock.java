...
import lantern_of_the_woodlands.procedures.Spell2waypointStartProcedure;
...
public class Spell2waypointBlockBlock extends LanternOfTheWoodlandsModElements.ModElement {
	@ObjectHolder("lantern_of_the_woodlands:spell_2waypoint_block")
	public static final Block block = null;

	public Spell2waypointBlockBlock(LanternOfTheWoodlandsModElements instance) {
		super(instance, 166);
	}
