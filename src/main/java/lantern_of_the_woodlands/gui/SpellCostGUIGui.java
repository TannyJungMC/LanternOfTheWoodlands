...
import lantern_of_the_woodlands.procedures.SpellCostTestProcedure;
...
public class SpellCostGUIGui extends LanternOfTheWoodlandsModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;

	public SpellCostGUIGui(LanternOfTheWoodlandsModElements instance) {
		super(instance, 114);
	...
	static void handleButtonAction(PlayerEntity entity, int buttonID, int x, int y, int z) {
		...
		if (buttonID == 0) {
			...
			SpellCostTestProcedure.executeProcedure(Stream
