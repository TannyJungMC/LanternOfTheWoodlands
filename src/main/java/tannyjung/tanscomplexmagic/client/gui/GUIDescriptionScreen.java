...
import tannyjung.tanscomplexmagic.world.inventory.GUIDescriptionMenu;
import tannyjung.tanscomplexmagic.procedures.*;
import tannyjung.tanscomplexmagic.network.GUIDescriptionButtonMessage;
...
public class GUIDescriptionScreen extends AbstractContainerScreen<GUIDescriptionMenu> implements TanscomplexmagicModScreens.ScreenAccessor {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("tanscomplexmagic:textures/screens/gui_description.png");
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int mouseX, int mouseY) {
		...
		guiGraphics.blit(ResourceLocation.parse("tanscomplexmagic:textures/screens/image_banner.png"), this.leftPos + -164, this.topPos + -72, 0, 0, 136, 28, 136, 28);
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		...
		guiGraphics.drawString(this.font, Component.translatable("gui.tanscomplexmagic.gui_description.label_lantern_of_the_woodlands_lotw"), -172, -18, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.tanscomplexmagic.gui_description.label_is_a_magic_mod_collection_of_my"), -180, -8, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.tanscomplexmagic.gui_description.label_magic_systems_added_a_spellbook"), -180, 2, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.tanscomplexmagic.gui_description.label_with_a_lot_of_functions_and_spel"), -180, 12, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.tanscomplexmagic.gui_description.label_to_use_the_spells_will_be_categ"), -180, 22, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.tanscomplexmagic.gui_description.label_categorized_like_magic_classes"), -180, 32, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.tanscomplexmagic.gui_description.label_those_classes_also_contain_subcl"), -180, 42, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.tanscomplexmagic.gui_description.label_subclasses_user_can_choose_a_cl"), -180, 52, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.tanscomplexmagic.gui_description.label_user_can_choose_a_class_they_lik"), -180, 62, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.tanscomplexmagic.gui_description.label_their_magic_this_mod_designs_to"), -180, 72, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.tanscomplexmagic.gui_description.label_this_mod_designs_to_be_like_idle"), 20, -104, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.tanscomplexmagic.gui_description.label_games_the_only_thing_you_need_t"), 12, -94, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.tanscomplexmagic.gui_description.label_upgrade_the_magic_is_your_time"), 12, -84, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.tanscomplexmagic.gui_description.label_the_more_time_you_spend_the_mor"), 12, -74, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.tanscomplexmagic.gui_description.label_you_become_a_master_of_that_magi"), 12, -64, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.tanscomplexmagic.gui_description.label_this_mod_combines_of_mcreator_an"), 20, -34, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.tanscomplexmagic.gui_description.label_and_my_command_block_skills_rem"), 12, -24, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.tanscomplexmagic.gui_description.label_remake_of_lantern_staff_from_m"), 12, -14, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.tanscomplexmagic.gui_description.label_my_skywiza_command_block_system"), 12, -4, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.tanscomplexmagic.gui_description.label_a_master_of_that_magic"), 12, -54, -12829636, false);
	}
	...
	public void init() {
		...
		imagebutton_gui_component_close = new ImageButton(this.leftPos + 204, this.topPos + 112, 8, 8,
				new WidgetSprites(ResourceLocation.parse("tanscomplexmagic:textures/screens/gui_component_close.png"), ResourceLocation.parse("tanscomplexmagic:textures/screens/gui_component_close_hovered.png")), e -> {
					int x = GUIDescriptionScreen.this.x;
					int y = GUIDescriptionScreen.this.y;
					if (true) {
						PacketDistributor.sendToServer(new GUIDescriptionButtonMessage(0, x, y, z));
						GUIDescriptionButtonMessage.handleButtonAction(entity, 0, x, y, z);
					}
				}) {
			@Override
		...
		imagebutton_gui_component_page_previous = new ImageButton(this.leftPos + -188, this.topPos + 92, 16, 16,
				new WidgetSprites(ResourceLocation.parse("tanscomplexmagic:textures/screens/gui_component_page_previous.png"), ResourceLocation.parse("tanscomplexmagic:textures/screens/gui_component_page_previous_hovered.png")), e -> {
					...
					int y = GUIDescriptionScreen.this.y;
					if (true) {
						PacketDistributor.sendToServer(new GUIDescriptionButtonMessage(1, x, y, z));
						GUIDescriptionButtonMessage.handleButtonAction(entity, 1, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		imagebutton_gui_component_page_next = new ImageButton(this.leftPos + 172, this.topPos + 92, 16, 16,
				new WidgetSprites(ResourceLocation.parse("tanscomplexmagic:textures/screens/gui_component_page_next.png"), ResourceLocation.parse("tanscomplexmagic:textures/screens/gui_component_page_next_hovered.png")), e -> {
					...
					int y = GUIDescriptionScreen.this.y;
					if (true) {
						PacketDistributor.sendToServer(new GUIDescriptionButtonMessage(2, x, y, z));
						GUIDescriptionButtonMessage.handleButtonAction(entity, 2, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		imagebutton_gui_component_shortcut_home = new ImageButton(this.leftPos + -212, this.topPos + -108, 21, 8,
				new WidgetSprites(ResourceLocation.parse("tanscomplexmagic:textures/screens/gui_component_shortcut_home.png"), ResourceLocation.parse("tanscomplexmagic:textures/screens/gui_component_shortcut_home_hovered.png")), e -> {
					...
					int y = GUIDescriptionScreen.this.y;
					if (true) {
						PacketDistributor.sendToServer(new GUIDescriptionButtonMessage(3, x, y, z));
						GUIDescriptionButtonMessage.handleButtonAction(entity, 3, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		imagebutton_gui_component_shortcut_custom = new ImageButton(this.leftPos + -212, this.topPos + -96, 21, 8,
				new WidgetSprites(ResourceLocation.parse("tanscomplexmagic:textures/screens/gui_component_shortcut_custom.png"), ResourceLocation.parse("tanscomplexmagic:textures/screens/gui_component_shortcut_custom_hovered.png")), e -> {
					...
					int y = GUIDescriptionScreen.this.y;
					if (true) {
						PacketDistributor.sendToServer(new GUIDescriptionButtonMessage(4, x, y, z));
						GUIDescriptionButtonMessage.handleButtonAction(entity, 4, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		imagebutton_gui_component_shortcut_custom_set = new ImageButton(this.leftPos + -197, this.topPos + -87, 4, 4,
				new WidgetSprites(ResourceLocation.parse("tanscomplexmagic:textures/screens/gui_component_shortcut_custom_set.png"), ResourceLocation.parse("tanscomplexmagic:textures/screens/gui_component_shortcut_custom_set_hovered.png")), e -> {
					...
					int y = GUIDescriptionScreen.this.y;
					if (true) {
						PacketDistributor.sendToServer(new GUIDescriptionButtonMessage(5, x, y, z));
						GUIDescriptionButtonMessage.handleButtonAction(entity, 5, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		imagebutton_gui_component_log_type_set = new ImageButton(this.leftPos + 6, this.topPos + 110, 7, 7,
				new WidgetSprites(ResourceLocation.parse("tanscomplexmagic:textures/screens/gui_component_log_type_set.png"), ResourceLocation.parse("tanscomplexmagic:textures/screens/gui_component_log_type_set_hovered.png")), e -> {
					...
					int y = GUIDescriptionScreen.this.y;
					if (true) {
						PacketDistributor.sendToServer(new GUIDescriptionButtonMessage(9, x, y, z));
						GUIDescriptionButtonMessage.handleButtonAction(entity, 9, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		imagebutton_gui_component_compass_custom_set = new ImageButton(this.leftPos + -164, this.topPos + 112, 3, 3,
				new WidgetSprites(ResourceLocation.parse("tanscomplexmagic:textures/screens/gui_component_compass_custom_set.png"), ResourceLocation.parse("tanscomplexmagic:textures/screens/gui_component_compass_custom_set_hovered.png")), e -> {
					...
					int y = GUIDescriptionScreen.this.y;
					if (true) {
						PacketDistributor.sendToServer(new GUIDescriptionButtonMessage(10, x, y, z));
						GUIDescriptionButtonMessage.handleButtonAction(entity, 10, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
