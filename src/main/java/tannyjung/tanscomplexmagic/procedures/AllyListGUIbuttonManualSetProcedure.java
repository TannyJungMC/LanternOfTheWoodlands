...
public class AllyListGUIbuttonManualSetProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		String chosen = "";
		if (!(entity.getData(TanscomplexmagicModVariables.PLAYER_VARIABLES).user_DELETE_THIS).equals("")) {
			chosen = ("@e[" + entity.getData(TanscomplexmagicModVariables.PLAYER_VARIABLES).ally_list_manual + ",tag=!<ID>-ally]").replace("<ID>", entity.getData(TanscomplexmagicModVariables.PLAYER_VARIABLES).user_DELETE_THIS);
