...
import lantern_of_the_woodlands.procedures.Spell6pauseTRUEProcedure;
import lantern_of_the_woodlands.procedures.Spell6pauseFALSEProcedure;
...
public class Spell6GUIGuiWindow extends ContainerScreen<Spell6GUIGui.GuiContainerMod> {
	...
	protected void drawGuiContainerBackgroundLayer(MatrixStack ms, float partialTicks, int gx, int gy) {
		...
		Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("lantern_of_the_woodlands:textures/screens/spell6image.png"));
	...
	protected void drawGuiContainerForegroundLayer(MatrixStack ms, int mouseX, int mouseY) {
		...
		this.font.drawString(ms, "Oak Tree x1", 68, -92, -10092442);
		this.font.drawString(ms, "Grass x8", 68, -68, -10066432);
		this.font.drawString(ms, "Dirt x8", 68, -44, -10066432);
		this.font.drawString(ms, "Stone x8", 68, -20, -10066432);
	}
	...
	public void init(Minecraft minecraft, int width, int height) {
		...
		this.addButton(new Button(this.guiLeft + 160, this.guiTop + 72, 48, 20, new StringTextComponent("Close"), e -> {
			if (true) {
				LanternOfTheWoodlandsMod.PACKET_HANDLER.sendToServer(new Spell6GUIGui.ButtonPressedMessage(0, x, y, z));
		...
		this.addButton(new Button(this.guiLeft + -79, this.guiTop + 72, 88, 20, new StringTextComponent("Cancel Spell"), e -> {
			if (true) {
				LanternOfTheWoodlandsMod.PACKET_HANDLER.sendToServer(new Spell6GUIGui.ButtonPressedMessage(1, x, y, z));
		...
		this.addButton(new Button(this.guiLeft + -63, this.guiTop + 36, 52, 20, new StringTextComponent("Show"), e -> {
			if (true) {
				LanternOfTheWoodlandsMod.PACKET_HANDLER.sendToServer(new Spell6GUIGui.ButtonPressedMessage(2, x, y, z));
		...
		this.addButton(new Button(this.guiLeft + -11, this.guiTop + 36, 52, 20, new StringTextComponent("Hide"), e -> {
			if (true) {
				LanternOfTheWoodlandsMod.PACKET_HANDLER.sendToServer(new Spell6GUIGui.ButtonPressedMessage(3, x, y, z));
		...
		this.addButton(new Button(this.guiLeft + 52, this.guiTop + 36, 8, 20, new StringTextComponent(">"), e -> {
			if (Spell6pauseTRUEProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("world", world)).collect(HashMap::new,
				...
				LanternOfTheWoodlandsMod.PACKET_HANDLER.sendToServer(new Spell6GUIGui.ButtonPressedMessage(4, x, y, z));
		...
		this.addButton(new Button(this.guiLeft + 44, this.guiTop + 36, 8, 20, new StringTextComponent("="), e -> {
			if (Spell6pauseFALSEProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("world", world)).collect(HashMap::new,
					(_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll))) {
				LanternOfTheWoodlandsMod.PACKET_HANDLER.sendToServer(new Spell6GUIGui.ButtonPressedMessage(5, x, y, z));
		...
		this.addButton(new Button(this.guiLeft + 140, this.guiTop + -96, 44, 20, new StringTextComponent("1 mana"), e -> {
			if (true) {
				LanternOfTheWoodlandsMod.PACKET_HANDLER.sendToServer(new Spell6GUIGui.ButtonPressedMessage(6, x, y, z));
		...
		this.addButton(new Button(this.guiLeft + 184, this.guiTop + -96, 8, 20, new StringTextComponent("x"), e -> {
			if (true) {
				LanternOfTheWoodlandsMod.PACKET_HANDLER.sendToServer(new Spell6GUIGui.ButtonPressedMessage(7, x, y, z));
		...
		this.addButton(new Button(this.guiLeft + 44, this.guiTop + 36, 8, 20, new StringTextComponent(" "), e -> {
			if (Spell6pauseTRUEProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("world", world)).collect(HashMap::new,
					(_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll))) {
				LanternOfTheWoodlandsMod.PACKET_HANDLER.sendToServer(new Spell6GUIGui.ButtonPressedMessage(8, x, y, z));
		...
		this.addButton(new Button(this.guiLeft + 52, this.guiTop + 36, 8, 20, new StringTextComponent(" "), e -> {
			if (Spell6pauseFALSEProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("world", world)).collect(HashMap::new,
					(_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll))) {
				LanternOfTheWoodlandsMod.PACKET_HANDLER.sendToServer(new Spell6GUIGui.ButtonPressedMessage(9, x, y, z));
		...
		this.addButton(new Button(this.guiLeft + 140, this.guiTop + -72, 44, 20, new StringTextComponent("1 mana"), e -> {
			if (true) {
				LanternOfTheWoodlandsMod.PACKET_HANDLER.sendToServer(new Spell6GUIGui.ButtonPressedMessage(10, x, y, z));
		...
		this.addButton(new Button(this.guiLeft + 184, this.guiTop + -72, 8, 20, new StringTextComponent("x"), e -> {
			if (true) {
				LanternOfTheWoodlandsMod.PACKET_HANDLER.sendToServer(new Spell6GUIGui.ButtonPressedMessage(11, x, y, z));
		...
		this.addButton(new Button(this.guiLeft + 140, this.guiTop + -48, 44, 20, new StringTextComponent("1 mana"), e -> {
			if (true) {
				LanternOfTheWoodlandsMod.PACKET_HANDLER.sendToServer(new Spell6GUIGui.ButtonPressedMessage(12, x, y, z));
		...
		this.addButton(new Button(this.guiLeft + 184, this.guiTop + -48, 8, 20, new StringTextComponent("x"), e -> {
			if (true) {
				LanternOfTheWoodlandsMod.PACKET_HANDLER.sendToServer(new Spell6GUIGui.ButtonPressedMessage(13, x, y, z));
		...
		this.addButton(new Button(this.guiLeft + 140, this.guiTop + -24, 44, 20, new StringTextComponent("1 mana"), e -> {
			if (true) {
				LanternOfTheWoodlandsMod.PACKET_HANDLER.sendToServer(new Spell6GUIGui.ButtonPressedMessage(14, x, y, z));
		...
		this.addButton(new Button(this.guiLeft + 184, this.guiTop + -24, 8, 20, new StringTextComponent("x"), e -> {
			if (true) {
				LanternOfTheWoodlandsMod.PACKET_HANDLER.sendToServer(new Spell6GUIGui.ButtonPressedMessage(15, x, y, z));
