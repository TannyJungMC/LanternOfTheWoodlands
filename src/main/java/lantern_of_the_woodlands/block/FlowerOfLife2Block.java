...
public class FlowerOfLife2Block extends LanternOfTheWoodlandsModElements.ModElement {
	@ObjectHolder("lantern_of_the_woodlands:flower_of_life_2")
	public static final Block block = null;

	public FlowerOfLife2Block(LanternOfTheWoodlandsModElements instance) {
		super(instance, 504);
	}
