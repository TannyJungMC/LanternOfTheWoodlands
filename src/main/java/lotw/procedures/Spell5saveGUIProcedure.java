	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				LotwMod.LOGGER.warn("Failed to load dependency world for procedure Spell5saveGUI!");
			return;
		}
		if (dependencies.get("guistate") == null) {
			if (!dependencies.containsKey("guistate"))
				LotwMod.LOGGER.warn("Failed to load dependency guistate for procedure Spell5saveGUI!");
			return;
		}
		IWorld world = (IWorld) dependencies.get("world");
		HashMap guistate = (HashMap) dependencies.get("guistate");
		LotwModVariables.MapVariables.get(world).spell5_radius = (new Object() {
		...
		LotwModVariables.MapVariables.get(world).spell5_safe_zone = (new Object() {
			public String getText() {
		...
		LotwModVariables.MapVariables.get(world).syncData(world);
		LotwModVariables.MapVariables.get(world).spell5_circle_frequency = (new Object() {
			public String getText() {
		...
		LotwModVariables.MapVariables.get(world).syncData(world);
		LotwModVariables.MapVariables.get(world).spell5_degree_frequency = (new Object() {
			public String getText() {
		...
		LotwModVariables.MapVariables.get(world).syncData(world);
		LotwModVariables.MapVariables.get(world).spell5_down = (new Object() {
			public String getText() {
		...
		LotwModVariables.MapVariables.get(world).syncData(world);
		LotwModVariables.MapVariables.get(world).spell5_height = (new Object() {
			public String getText() {
		...
		LotwModVariables.MapVariables.get(world).syncData(world);
		LotwModVariables.MapVariables.get(world).spell5_thickness = (new Object() {
			public String getText() {
		...
		LotwModVariables.MapVariables.get(world).syncData(world);
		LotwModVariables.MapVariables.get(world).spell5_room = (new Object() {
			public String getText() {
		...
		LotwModVariables.MapVariables.get(world).syncData(world);
		LotwModVariables.MapVariables.get(world).spell5_no_wall = (new Object() {
			public String getText() {
		...
		LotwModVariables.MapVariables.get(world).syncData(world);
		LotwModVariables.MapVariables.get(world).spell5_trap = (new Object() {
			public String getText() {
