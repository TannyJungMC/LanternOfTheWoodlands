...
import lantern_of_the_woodlands.procedures.MzeNoGenTickProcedure;
...
public class MazeNoGenBlock extends LanternOfTheWoodlandsModElements.ModElement {
	@ObjectHolder("lantern_of_the_woodlands:maze_no_gen")
	public static final Block block = null;

	public MazeNoGenBlock(LanternOfTheWoodlandsModElements instance) {
		super(instance, 552);
	}
