...
public class FlowerOfLife7Block extends LanternOfTheWoodlandsModElements.ModElement {
	@ObjectHolder("lantern_of_the_woodlands:flower_of_life_7")
	public static final Block block = null;

	public FlowerOfLife7Block(LanternOfTheWoodlandsModElements instance) {
		super(instance, 509);
	}
