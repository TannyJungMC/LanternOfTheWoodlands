...
public class PaperBombKunaiItem extends LanternOfTheWoodlandsModElements.ModElement {
	@ObjectHolder("lantern_of_the_woodlands:paper_bomb_kunai")
	public static final Item block = null;

	public PaperBombKunaiItem(LanternOfTheWoodlandsModElements instance) {
		super(instance, 431);
	}
	...
	public void initElements() {
		elements.items.add(() -> new SwordItem(new IItemTier() {
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("> explosion while reload"));
				list.add(new StringTextComponent("--------------------"));
			}
		}.setRegistryName("paper_bomb_kunai"));
	}
}
