...
public class FlowerOfLife6Block extends LanternOfTheWoodlandsModElements.ModElement {
	@ObjectHolder("lantern_of_the_woodlands:flower_of_life_6")
	public static final Block block = null;

	public FlowerOfLife6Block(LanternOfTheWoodlandsModElements instance) {
		super(instance, 508);
	}
