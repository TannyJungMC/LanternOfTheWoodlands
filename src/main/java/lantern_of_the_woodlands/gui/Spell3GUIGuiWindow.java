...
import lantern_of_the_woodlands.procedures.Spell3walkTRUEProcedure;
import lantern_of_the_woodlands.procedures.Spell3startTRUEProcedure;
import lantern_of_the_woodlands.procedures.Spell3startPauseTRUEProcedure;
import lantern_of_the_woodlands.procedures.Spell3startPauseFALSEProcedure;
import lantern_of_the_woodlands.procedures.Spell3startFALSEProcedure;
import lantern_of_the_woodlands.procedures.Spell3speedNot16Procedure;
import lantern_of_the_woodlands.procedures.Spell3speed8Procedure;
import lantern_of_the_woodlands.procedures.Spell3speed4Procedure;
import lantern_of_the_woodlands.procedures.Spell3speed2Procedure;
import lantern_of_the_woodlands.procedures.Spell3speed1Procedure;
import lantern_of_the_woodlands.procedures.Spell3removeINStrueProcedure;
import lantern_of_the_woodlands.procedures.Spell3removeINSfalseProcedure;
import lantern_of_the_woodlands.procedures.Spell3noDomeTRUEProcedure;
import lantern_of_the_woodlands.procedures.Spell3invisibleDomeTRUEProcedure;
import lantern_of_the_woodlands.procedures.Spell3genTRUEProcedure;
import lantern_of_the_woodlands.procedures.Spell3genFALSEProcedure;
import lantern_of_the_woodlands.procedures.Spell3domeParticleTRUEProcedure;
import lantern_of_the_woodlands.procedures.Spell3blockDamageTRUEProcedure;
import lantern_of_the_woodlands.procedures.Spell3blockArrowTRUEProcedure;
import lantern_of_the_woodlands.procedures.Spell3GUIcheckParticleProcedure;
import lantern_of_the_woodlands.procedures.Spell3CancelFULLtextProcedure;
...
public class Spell3GUIGuiWindow extends ContainerScreen<Spell3GUIGui.GuiContainerMod> {
	...
	protected void drawGuiContainerBackgroundLayer(MatrixStack ms, float partialTicks, int gx, int gy) {
		...
		Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("lantern_of_the_woodlands:textures/screens/spell3dome.png"));
		this.blit(ms, this.guiLeft + -83, this.guiTop + -92, 0, 0, 160, 160, 160, 160);

		Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("lantern_of_the_woodlands:textures/screens/spell3dome2.png"));
	...
	protected void drawGuiContainerForegroundLayer(MatrixStack ms, int mouseX, int mouseY) {
		...
		this.font.drawString(ms, "Under The Dome", -43, -92, -16777216);
		...
		this.font.drawString(ms, "Radius (even number)", 80, -48, -13421773);
		if (Spell3removeINSfalseProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("world", world)).collect(HashMap::new,
			...
			this.font.drawString(ms, "" + (LanternOfTheWoodlandsModVariables.MapVariables.get(world).spell3_show_percent_status) + " - "
					+ (LanternOfTheWoodlandsModVariables.MapVariables.get(world).spell3_show_percent) + "%", 72, 12, -6750208);
		if (Spell3removeINSfalseProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("world", world)).collect(HashMap::new,
				(_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll)))
			this.font.drawString(ms, "Time Left - " + (LanternOfTheWoodlandsModVariables.MapVariables.get(world).spell3_show_time) + "", 72, 24,
					-16751002);
		if (Spell3speed1Procedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("world", world)).collect(HashMap::new,
				(_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll)))
			this.font.drawString(ms, "x2 speed", 128, 44, -13421773);
		if (Spell3speed2Procedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("world", world)).collect(HashMap::new,
				(_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll)))
			this.font.drawString(ms, "x4 speed", 128, 44, -13421773);
		if (Spell3speed4Procedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("world", world)).collect(HashMap::new,
				(_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll)))
			this.font.drawString(ms, "x8 speed", 128, 44, -13421773);
		if (Spell3speed8Procedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("world", world)).collect(HashMap::new,
				(_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll)))
			this.font.drawString(ms, "x16 speed", 128, 44, -13421773);
		...
		if (Spell3removeINStrueProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("world", world)).collect(HashMap::new,
				(_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll)))
			this.font.drawString(ms, "Stop Creating/Removing", 72, 12, -16751104);
		if (Spell3removeINStrueProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("world", world)).collect(HashMap::new,
				(_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll)))
			this.font.drawString(ms, "click again to confirm", 76, 24, -10066330);
	}
	...
	public void init(Minecraft minecraft, int width, int height) {
		...
		this.addButton(new Button(this.guiLeft + 160, this.guiTop + 72, 48, 20, new StringTextComponent("Close"), e -> {
			if (true) {
				LanternOfTheWoodlandsMod.PACKET_HANDLER.sendToServer(new Spell3GUIGui.ButtonPressedMessage(0, x, y, z));
		...
		this.addButton(new Button(this.guiLeft + -79, this.guiTop + 72, 88, 20, new StringTextComponent("Cancel Spell"), e -> {
			if (true) {
				LanternOfTheWoodlandsMod.PACKET_HANDLER.sendToServer(new Spell3GUIGui.ButtonPressedMessage(1, x, y, z));
		...
		this.addButton(new Button(this.guiLeft + 72, this.guiTop + 40, 48, 20, new StringTextComponent("15 mana"), e -> {
			if (Spell3speedNot16Procedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("world", world)).collect(HashMap::new,
					(_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll))) {
				LanternOfTheWoodlandsMod.PACKET_HANDLER.sendToServer(new Spell3GUIGui.ButtonPressedMessage(2, x, y, z));
		...
		this.addButton(new Button(this.guiLeft + 72, this.guiTop + -12, 50, 20, new StringTextComponent("Create"), e -> {
			if (Spell3genFALSEProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("world", world)).collect(HashMap::new,
					(_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll))) {
				LanternOfTheWoodlandsMod.PACKET_HANDLER.sendToServer(new Spell3GUIGui.ButtonPressedMessage(3, x, y, z));
		...
		this.addButton(new Button(this.guiLeft + 72, this.guiTop + -12, 50, 20, new StringTextComponent(" "), e -> {
			if (Spell3genTRUEProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("world", world)).collect(HashMap::new,
					(_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll))) {
				LanternOfTheWoodlandsMod.PACKET_HANDLER.sendToServer(new Spell3GUIGui.ButtonPressedMessage(4, x, y, z));
		...
		this.addButton(new Button(this.guiLeft + 122, this.guiTop + -12, 50, 20, new StringTextComponent("Remove"), e -> {
			if (Spell3genTRUEProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("world", world)).collect(HashMap::new,
					(_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll))) {
				LanternOfTheWoodlandsMod.PACKET_HANDLER.sendToServer(new Spell3GUIGui.ButtonPressedMessage(5, x, y, z));
		...
		this.addButton(new Button(this.guiLeft + 180, this.guiTop + -12, 8, 20, new StringTextComponent("!"), e -> {
			if (Spell3startTRUEProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("world", world)).collect(HashMap::new,
					(_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll))) {
				LanternOfTheWoodlandsMod.PACKET_HANDLER.sendToServer(new Spell3GUIGui.ButtonPressedMessage(6, x, y, z));
		...
		this.addButton(new Button(this.guiLeft + 122, this.guiTop + -12, 50, 20, new StringTextComponent(" "), e -> {
			if (Spell3genFALSEProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("world", world)).collect(HashMap::new,
					(_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll))) {
				LanternOfTheWoodlandsMod.PACKET_HANDLER.sendToServer(new Spell3GUIGui.ButtonPressedMessage(7, x, y, z));
		...
		this.addButton(new Button(this.guiLeft + 176, this.guiTop + -36, 8, 20, new StringTextComponent("="), e -> {
			if (Spell3startPauseFALSEProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("world", world)).collect(HashMap::new,
					(_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll))) {
				LanternOfTheWoodlandsMod.PACKET_HANDLER.sendToServer(new Spell3GUIGui.ButtonPressedMessage(8, x, y, z));
		...
		this.addButton(new Button(this.guiLeft + 176, this.guiTop + -36, 8, 20, new StringTextComponent(" "), e -> {
			if (Spell3startPauseTRUEProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("world", world)).collect(HashMap::new,
					(_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll))) {
				LanternOfTheWoodlandsMod.PACKET_HANDLER.sendToServer(new Spell3GUIGui.ButtonPressedMessage(9, x, y, z));
		...
		this.addButton(new Button(this.guiLeft + 184, this.guiTop + -36, 8, 20, new StringTextComponent(">"), e -> {
			if (Spell3startPauseTRUEProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("world", world)).collect(HashMap::new,
					(_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll))) {
				LanternOfTheWoodlandsMod.PACKET_HANDLER.sendToServer(new Spell3GUIGui.ButtonPressedMessage(10, x, y, z));
		...
		this.addButton(new Button(this.guiLeft + 184, this.guiTop + -36, 8, 20, new StringTextComponent(" "), e -> {
			if (Spell3startPauseFALSEProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("world", world)).collect(HashMap::new,
					(_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll))) {
				LanternOfTheWoodlandsMod.PACKET_HANDLER.sendToServer(new Spell3GUIGui.ButtonPressedMessage(11, x, y, z));
		...
		this.addButton(new Button(this.guiLeft + 148, this.guiTop + -36, 24, 20, new StringTextComponent("Use"), e -> {
			if (Spell3startFALSEProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("world", world)).collect(HashMap::new,
					(_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll))) {
				LanternOfTheWoodlandsMod.PACKET_HANDLER.sendToServer(new Spell3GUIGui.ButtonPressedMessage(12, x, y, z));
		...
		this.addButton(new Button(this.guiLeft + 148, this.guiTop + -36, 24, 20, new StringTextComponent(" "), e -> {
			if (Spell3startTRUEProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("world", world)).collect(HashMap::new,
					(_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll))) {
				LanternOfTheWoodlandsMod.PACKET_HANDLER.sendToServer(new Spell3GUIGui.ButtonPressedMessage(13, x, y, z));
		...
		this.addButton(new Button(this.guiLeft + -87, this.guiTop + 72, 8, 20, new StringTextComponent("!"), e -> {
			if (Spell3genTRUEProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("world", world)).collect(HashMap::new,
					(_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll))) {
				LanternOfTheWoodlandsMod.PACKET_HANDLER.sendToServer(new Spell3GUIGui.ButtonPressedMessage(14, x, y, z));
