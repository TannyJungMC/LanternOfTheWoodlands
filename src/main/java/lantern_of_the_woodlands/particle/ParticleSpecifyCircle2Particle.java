...
package lantern_of_the_woodlands.particle;
...
public class ParticleSpecifyCircle2Particle {
	...
	public static void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("particle_specify_circle_2"));
	}
