...
public class FlowerOfLife8Block extends LanternOfTheWoodlandsModElements.ModElement {
	@ObjectHolder("lantern_of_the_woodlands:flower_of_life_8")
	public static final Block block = null;

	public FlowerOfLife8Block(LanternOfTheWoodlandsModElements instance) {
		super(instance, 530);
	}
