...
import lotw.procedures.BasicSpell3whenPlaceProcedure;
import lotw.procedures.BasicSpell3inBlockProcedure;
...
public class WinterWindBlockBlock extends LotwModElements.ModElement {
	@ObjectHolder("lotw:winter_wind_block")
	public static final Block block = null;

	public WinterWindBlockBlock(LotwModElements instance) {
		super(instance, 323);
	}
