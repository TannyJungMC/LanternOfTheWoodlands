...
import lotw.procedures.Spell4keyResetRUNProcedure;
...
public class Spell4keyResetKeyBinding extends LotwModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public Spell4keyResetKeyBinding(LotwModElements instance) {
		super(instance, 360);
	...
	public void initElements() {
		keys = new KeyBinding("key.lotw.spell_4key_reset", GLFW.GLFW_KEY_TAB, "key.categories.lotw");
