...
public class Spell7keyNext10RunProcedure {

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				LotwMod.LOGGER.warn("Failed to load dependency world for procedure Spell7keyNext10Run!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				LotwMod.LOGGER.warn("Failed to load dependency x for procedure Spell7keyNext10Run!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				LotwMod.LOGGER.warn("Failed to load dependency y for procedure Spell7keyNext10Run!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				LotwMod.LOGGER.warn("Failed to load dependency z for procedure Spell7keyNext10Run!");
			return;
		}
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				LotwMod.LOGGER.warn("Failed to load dependency entity for procedure Spell7keyNext10Run!");
			return;
		}
		...
		if (LotwModVariables.MapVariables.get(world).user_only == true && LotwModVariables.MapVariables.get(world).spell7_start == true) {
			LotwModVariables.MapVariables.get(world).spell7_book_number = (LotwModVariables.MapVariables.get(world).spell7_book_number + 10);
			LotwModVariables.MapVariables.get(world).syncData(world);
			if (LotwModVariables.MapVariables.get(world).spell7_book_number > 40) {
				LotwModVariables.MapVariables.get(world).spell7_book_number = (LotwModVariables.MapVariables.get(world).spell7_book_number - 40);
				LotwModVariables.MapVariables.get(world).syncData(world);
			}
			if (true) {
