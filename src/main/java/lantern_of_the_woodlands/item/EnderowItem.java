...
public class EnderowItem extends LanternOfTheWoodlandsModElements.ModElement {
	@ObjectHolder("lantern_of_the_woodlands:enderow")
	public static final Item block = null;

	public EnderowItem(LanternOfTheWoodlandsModElements instance) {
		super(instance, 430);
	}
	...
	public void initElements() {
		elements.items.add(() -> new SwordItem(new IItemTier() {
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("> teleport you to arrow position while reload"));
				list.add(new StringTextComponent("--------------------"));
			}
		}.setRegistryName("enderow"));
	}
}
