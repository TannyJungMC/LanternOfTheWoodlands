	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				LanternOfTheWoodlandsMod.LOGGER.warn("Failed to load dependency world for procedure Spell5runTestDegree360!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				LanternOfTheWoodlandsMod.LOGGER.warn("Failed to load dependency x for procedure Spell5runTestDegree360!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				LanternOfTheWoodlandsMod.LOGGER.warn("Failed to load dependency y for procedure Spell5runTestDegree360!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				LanternOfTheWoodlandsMod.LOGGER.warn("Failed to load dependency z for procedure Spell5runTestDegree360!");
			return;
		}
		...
		if (LanternOfTheWoodlandsModVariables.MapVariables.get(world).spell5_safe_zone_360 > 0) {
			LanternOfTheWoodlandsModVariables.MapVariables
					.get(world).spell5_safe_zone_360 = (LanternOfTheWoodlandsModVariables.MapVariables.get(world).spell5_safe_zone_360 - 1);
			...
			LanternOfTheWoodlandsModVariables.MapVariables.get(world).spell5_degree_frequency_save = new Object() {
			...
			LanternOfTheWoodlandsModVariables.MapVariables.get(world).syncData(world);
			LanternOfTheWoodlandsModVariables.MapVariables
					.get(world).spell5_radius_save = (LanternOfTheWoodlandsModVariables.MapVariables.get(world).spell5_radius_save - (new Object() {
						double convert(String s) {
							try {
								return Double.parseDouble(s.trim());
							} catch (Exception e) {
			...
			LanternOfTheWoodlandsModVariables.MapVariables.get(world).syncData(world);
			LanternOfTheWoodlandsModVariables.MapVariables.get(world).spell5_trap_degree = Math.ceil(new Object() {
				double convert(String s) {
					try {
						return Double.parseDouble(s.trim());
					} catch (Exception e) {
			...
			}.convert(LanternOfTheWoodlandsModVariables.MapVariables.get(world).spell5_degree_frequency) / 2);
			LanternOfTheWoodlandsModVariables.MapVariables.get(world).syncData(world);
		} else {
			if (LanternOfTheWoodlandsModVariables.MapVariables.get(world).spell5_remove) {
				...
				if (LanternOfTheWoodlandsModVariables.MapVariables.get(world).spell5_always_gen) {
					...
					if (world instanceof ServerWorld) {
						((World) world).getServer().getCommandManager().handleCommand(
								...
								("/execute at @e[type=armor_stand,name=placed_lantern] run summon armor_stand ~ ~-"
										+ LanternOfTheWoodlandsModVariables.MapVariables.get(world).spell5_down
