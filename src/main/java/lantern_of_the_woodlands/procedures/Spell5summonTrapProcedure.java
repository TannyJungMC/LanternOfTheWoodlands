	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				LanternOfTheWoodlandsMod.LOGGER.warn("Failed to load dependency world for procedure Spell5summonTrap!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				LanternOfTheWoodlandsMod.LOGGER.warn("Failed to load dependency x for procedure Spell5summonTrap!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				LanternOfTheWoodlandsMod.LOGGER.warn("Failed to load dependency y for procedure Spell5summonTrap!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				LanternOfTheWoodlandsMod.LOGGER.warn("Failed to load dependency z for procedure Spell5summonTrap!");
			return;
		}
		...
		LanternOfTheWoodlandsModVariables.MapVariables
				.get(world).spell5_trap_degree = (LanternOfTheWoodlandsModVariables.MapVariables.get(world).spell5_trap_degree + new Object() {
		...
		if (world instanceof ServerWorld) {
			((World) world).getServer().getCommandManager().handleCommand(
					...
					("/execute at @e[type=armor_stand,name=Mazer1] as @e[type=armor_stand,name=MazerTrapSummon,limit=1,sort=nearest] at @s run tp @s ~ ~"
							...
							}.convert(LanternOfTheWoodlandsModVariables.MapVariables.get(world).spell5_height) + " ~ ~ 0"));
		}
		if (world instanceof ServerWorld) {
			((World) world).getServer().getCommandManager().handleCommand(
					new CommandSource(ICommandSource.DUMMY, new Vector3d(x, y, z), Vector2f.ZERO, (ServerWorld) world, 4, "",
					...
					}.convert(LanternOfTheWoodlandsModVariables.MapVariables.get(world).spell5_height)
		...
		new Object() {
			...
			private void run() {
				if (LanternOfTheWoodlandsModVariables.MapVariables.get(world).spell5_remove == false) {
					...
					}.convert(LanternOfTheWoodlandsModVariables.MapVariables.get(world).spell5_trap) / 100) / 6) {
						if (world instanceof ServerWorld) {
							((World) world).getServer().getCommandManager().handleCommand(
									new CommandSource(ICommandSource.DUMMY, new Vector3d(x, y, z), Vector2f.ZERO, (ServerWorld) world, 4, "",
											new StringTextComponent(""), ((World) world).getServer(), null).withFeedbackDisabled(),
