...
import lantern_of_the_woodlands.procedures.IllusionStoneWhenPlaceProcedure;
...
public class IllusionStoneBlock extends LanternOfTheWoodlandsModElements.ModElement {
	@ObjectHolder("lantern_of_the_woodlands:illusion_stone")
	public static final Block block = null;

	public IllusionStoneBlock(LanternOfTheWoodlandsModElements instance) {
		super(instance, 585);
	}
