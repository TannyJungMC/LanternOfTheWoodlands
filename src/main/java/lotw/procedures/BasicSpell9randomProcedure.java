...
import lotw.block.FlowerOfLife8Block;
import lotw.block.FlowerOfLife7Block;
import lotw.block.FlowerOfLife6Block;
import lotw.block.FlowerOfLife5Block;
import lotw.block.FlowerOfLife4Block;
import lotw.block.FlowerOfLife3Block;
import lotw.block.FlowerOfLife2Block;
import lotw.block.FlowerOfLife1Block;
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				LotwMod.LOGGER.warn("Failed to load dependency world for procedure BasicSpell9random!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				LotwMod.LOGGER.warn("Failed to load dependency x for procedure BasicSpell9random!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				LotwMod.LOGGER.warn("Failed to load dependency y for procedure BasicSpell9random!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				LotwMod.LOGGER.warn("Failed to load dependency z for procedure BasicSpell9random!");
			return;
		}
