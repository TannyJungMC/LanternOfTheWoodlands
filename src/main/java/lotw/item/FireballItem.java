...
import lotw.entity.renderer.FireballRenderer;
...
public class FireballItem extends LotwModElements.ModElement {
	@ObjectHolder("lotw:fireball")
	...
	public FireballItem(LotwModElements instance) {
		super(instance, 48);
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(LotwTabItemGroup.tab).maxDamage(10));
