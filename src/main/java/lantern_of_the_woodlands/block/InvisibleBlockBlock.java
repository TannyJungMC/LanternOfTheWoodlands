...
public class InvisibleBlockBlock extends LanternOfTheWoodlandsModElements.ModElement {
	@ObjectHolder("lantern_of_the_woodlands:invisible_block")
	public static final Block block = null;

	public InvisibleBlockBlock(LanternOfTheWoodlandsModElements instance) {
		super(instance, 289);
	}
