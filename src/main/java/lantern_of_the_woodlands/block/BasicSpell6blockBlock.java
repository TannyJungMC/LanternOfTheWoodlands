...
import lantern_of_the_woodlands.procedures.BasicSpell6whenPlaceProcedure;
...
public class BasicSpell6blockBlock extends LanternOfTheWoodlandsModElements.ModElement {
	@ObjectHolder("lantern_of_the_woodlands:basic_spell_6block")
	public static final Block block = null;

	public BasicSpell6blockBlock(LanternOfTheWoodlandsModElements instance) {
		super(instance, 342);
	}
