...
public class AllyListGUIButtonMessage {
	private final int buttonID, x, y, z;
	private HashMap<String, String> textstate;

	public AllyListGUIButtonMessage(FriendlyByteBuf buffer) {
	...
	public AllyListGUIButtonMessage(int buttonID, int x, int y, int z, HashMap<String, String> textstate) {
	...
	public static void buffer(AllyListGUIButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(AllyListGUIButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z, HashMap<String, String> textstate) {
		...
		HashMap guistate = AllyListGUIMenu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		LanternofthewoodlandsMod.addNetworkMessage(AllyListGUIButtonMessage.class, AllyListGUIButtonMessage::buffer, AllyListGUIButtonMessage::new, AllyListGUIButtonMessage::handler);
	}
