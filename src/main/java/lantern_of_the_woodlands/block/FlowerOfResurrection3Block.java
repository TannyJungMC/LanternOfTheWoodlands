...
public class FlowerOfResurrection3Block extends LanternOfTheWoodlandsModElements.ModElement {
	@ObjectHolder("lantern_of_the_woodlands:flower_of_resurrection_3")
	public static final Block block = null;

	public FlowerOfResurrection3Block(LanternOfTheWoodlandsModElements instance) {
		super(instance, 525);
	}
