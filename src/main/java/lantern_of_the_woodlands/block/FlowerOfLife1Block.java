...
import lantern_of_the_woodlands.procedures.BasicSpell9randomProcedure;
...
public class FlowerOfLife1Block extends LanternOfTheWoodlandsModElements.ModElement {
	@ObjectHolder("lantern_of_the_woodlands:flower_of_life_1")
	public static final Block block = null;

	public FlowerOfLife1Block(LanternOfTheWoodlandsModElements instance) {
		super(instance, 503);
	}
