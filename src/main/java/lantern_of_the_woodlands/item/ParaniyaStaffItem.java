...
public class ParaniyaStaffItem extends LanternOfTheWoodlandsModElements.ModElement {
	@ObjectHolder("lantern_of_the_woodlands:paraniya_staff")
	public static final Item block = null;

	public ParaniyaStaffItem(LanternOfTheWoodlandsModElements instance) {
		super(instance, 432);
	}
	...
	public void initElements() {
		elements.items.add(() -> new SwordItem(new IItemTier() {
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("> glowing all entities in area"));
				list.add(new StringTextComponent("--------------------"));
			}
		}.setRegistryName("paraniya_staff"));
	}
}
