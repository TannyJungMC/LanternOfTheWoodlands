...
public class FlowerOfLife4Block extends LanternOfTheWoodlandsModElements.ModElement {
	@ObjectHolder("lantern_of_the_woodlands:flower_of_life_4")
	public static final Block block = null;

	public FlowerOfLife4Block(LanternOfTheWoodlandsModElements instance) {
		super(instance, 506);
	}
